...
{day:55,week:11,name:'SAVAGE',theme:'Déload Force — Récupération Active',haltero:{name:'Overhead Squat',desc:'OHS contrôle total — stabilité overhead, pieds largeur snatch',scheme:'5x3 @70%',weights:'overhead_squat'},wod:{name:'SAVAGE',type:'AMRAP 15',movements:[{name:'Wall Ball',reps:10,gymnastics:'wall_ball'},{name:'Pistols',reps:5,gymnastics:'pistols'},{name:'KB Swing',reps:15,gymnastics:'kb_swing'}],notes:'AMRAP 15min. Déload — charge légère, effort 70-75% max. Wall ball: attraper haut, squat profond. Pistols: 5 total (alternance), atterrissage contrôlé. KB swing russe, hanches et fessiers. Cible 8-10 rounds. Respiration rythmée, ne jamais essouffler complètement. Récupération active, mobiliser hanches et épaules entre rounds.'},gym:{name:'Skill: Pistols',drills:['Mobilité cheville banded 2x60s','Pistol tempo 3-1-3 x3/jambe','Pistol chaîné 5 reps/jambe x3','Pistol sur boîte surélevée x5/jambe']},scaled:{movements:[{name:'Wall Ball',reps:10,note:'→ 6kg balle'},{name:'Pistols',reps:5,note:'→ Box Pistols'},{name:'KB Swing',reps:15,note:'→ 16kg'}],note:'Maintenir mouvements fluides, priorité amplitude'},rxPlus:{note:'RX+ Wall Ball 10kg + Pistols holding KB 12kg'}},
