...
{
  day: 19, week: 4, name: 'INFERNO', theme: 'Intervals Puissance',
...
{
  day: 26, week: 6, name: 'TITAN', theme: 'Force/Volume — Hang Clean + Interval Sprint',
  ...
  wod: { name: 'TITAN', type: '5 Rounds For Time (cap 20min)', movements: [
...
{
  day: 30, week: 6, name: 'NEMESIS', theme: 'Force/Volume — Snatch + Sprint Couplet',
  ...
  wod: { name: 'NEMESIS', type: '3 Rounds For Time (cap 12min)', movements: [
...
{
  day: 32, week: 7, name: 'WARLORD', theme: 'Force/Volume — Power Clean + EMOM Rotatif',
  ...
  wod: { name: 'WARLORD', type: 'EMOM 28 (7 rounds)', movements: [
...
{
  day: 33, week: 7, name: 'COLOSSUS', theme: 'Force/Volume — Clean & Jerk + Descending 21-15-9',
  ...
  wod: { name: 'COLOSSUS', type: '21-15-9 For Time (cap 14min)', movements: [
...
{
  day: 39, week: 8, name: 'FORTRESS', theme: 'Déload S2 — Back Squat Léger + Récupération Ciblée', deload: true,
  ...
  wod: { name: 'FORTRESS-LIGHT', type: 'For Time (cap 12min)', movements: [
...
{
  day: 41, week: 9, name: 'PHOENIX', theme: 'Force/Volume — Squat Clean + Chipper Rebirth',
...
{
  day: 44, week: 9, name: 'ATLAS', theme: 'Force/Volume — Front Squat + AMRAP Giant',
  ...
  wod: { name: 'ATLAS', type: 'AMRAP 22', movements: [
...
{
  day: 45, week: 9, name: 'VENOM', theme: 'Force/Volume — Hang Clean + Hero WOD Style',
  hero: true,
  ...
  wod: { name: 'VENOM', type: 'For Time (cap 22min)', movements: [
...
{
  day: 81, week: 17, name: 'TITAN', theme: 'Squat Clean Max + Triplet Games',
...
{
  day: 82, week: 17, name: 'COLOSSUS', theme: 'Snatch Lourd + AMRAP 20 Colosse',
  ...
  wod: { name: 'COLOSSUS', type: 'AMRAP 20', movements: [
    {name: 'Power Snatches', reps: 5, weight: 'snatch'},
    {name: 'HSPU', reps: 8, gymnastics: 'hspu'},
    {name: 'Box Jumps', reps: 12, gymnastics: 'box_jump'},
    {name: 'Cal Assault Bike', special: 'assault_bike'},
