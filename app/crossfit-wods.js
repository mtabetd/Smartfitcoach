...
{day:60,week:12,name:'FURY',theme:'Intensité Maximale — Semaine 12 Finale',haltero:{name:'Back Squat',desc:'Back squat test — tentative PR ou 95% 1RM actuel',scheme:'3-2-1 @88-92-95%',weights:'back_squat'},wod:{name:'FURY',type:'AMRAP 18',movements:[{name:'Thruster',reps:7,weight:'thruster'},{name:'Toes-to-Bar',reps:7,gymnastics:'toes_to_bar'},{name:'Double Unders',reps:50,gymnastics:'double_unders'},{name:'Assault Bike',reps:15,special:'assault_bike'}],notes:'FURY — finale semaine 12, intensité maximale AMRAP 18min combinant les 4 filières. Contexte peak S12 : ce WOD clôture la semaine la plus exigeante de la phase, il concentre thruster, TTB, DU et vélo dans un format répété qui épuise méthodiquement chaque système. Thruster 75% : 7 reps unbroken, jambes moteur principal — ne pas laisser les épaules faire le travail. Descente à squat complet, explosif depuis le bas, push press dans le même mouvement. TTB : 4+3 ou unbroken si possible. Le balancement arrière est votre allié — maintenir le kip même fatigué. DU 50 reps : surtout ne pas presser en fatigue. Rythme constant, corde légèrement plus lente que d\'habitude. Assault Bike 15 cal : effort 85%, jambes-bras équilibré. Pacing AMRAP 18min : rounds 1-2 pour calibrer, round 3-4 sont critiques (c\'est là que tout ralentit) — c\'est précisément là qu\'il faut maintenir le rythme. Vigilance : conserver la technique thruster même quand ça brûle — genou dans l\'axe, dos neutre. Scaling : 60% + knee raise + 100 SU + 12 cal. Cible 5-7 rounds.'},gym:{name:'Skill: Handstand Walk',drills:['HS Walk 25m sans pause x3','HS Walk descente pente x3','HS Walk push obstacle x4','HS Walk coordination bras x5']},scaled:{movements:[{name:'Thruster',reps:7,note:'→ 60% 1RM'},{name:'Toes-to-Bar',reps:7,note:'→ Hanging Knee Raise'},{name:'Double Unders',reps:50,note:'→ 100 Single Unders'},{name:'Assault Bike',reps:1,note:'→ 12 cal'}],note:'Priorité flux de mouvements sans arrêt, charge secondaire'},rxPlus:{note:'RX+ Thruster @82% + TTB strict + 75 DU + 18 cal'}},

{day:61,week:13,name:'BLAZE',theme:'Transition Phase — Force-Vitesse',haltero:{name:'Power Clean',desc:'Power clean vitesse maximale — barre légère, repositionnement ultra-rapide',scheme:'10x1 EMOM @75%',weights:'power_clean'},wod:{name:'BLAZE',type:'For Time',movements:[{name:'Hang Power Clean',reps:12,weight:'hang_clean'},{name:'Box Jump',reps:12,gymnastics:'box_jump'},{name:'Run',reps:1,special:'run_400'},{name:'Hang Power Clean',reps:10,weight:'hang_clean'},{name:'Box Jump',reps:10,gymnastics:'box_jump'},{name:'Run',reps:1,special:'run_400'},{name:'Hang Power Clean',reps:8,weight:'hang_clean'},{name:'Box Jump',reps:8,gymnastics:'box_jump'},{name:'Run',reps:1,special:'run_200'}],notes:'BLAZE — transition phase force-vitesse semaine 13, format décroissant hang clean + box jump + run. Contexte S13 : la vitesse d\'exécution prime sur la charge pure — semaine de conversion puissance. Hang Power Clean 70% : depuis les genoux, tirage haut agressif, coudes rapides sous la barre, réception haute. 12 reps en 4-4-4 ou 6-6. Pas de pause supérieure à 10s. 10 reps en 5-5. 8 reps unbroken. Box Jump : rebond élastique sans pause en position basse (stretch-shortening cycle), genoux fléchis à l\'atterrissage pour absorption. Descente step-down autorisée après les 10 premiers sauts pour préserver les tendons d\'Achille. Course 400m : allure 5K soutenue mais pas sprint — les jambes doivent tenir pour les box jumps. 200m final : sprint absolu, ne jamais marcher, c\'est le finish qui définit le score. Pacing : les 12 cleans initiaux conditionnent tout. Ne pas partir en mode sprint complet sur les premiers cleans. Vigilance : si dos arrondit sur hang clean, réduire à 65%. Scaling : 60% + step-up 50cm + 300m. Cible 14-18 min.'},gym:{name:'Skill: Pistols',drills:['Pistol 5 reps continus/jambe x3','Pistol avec rotation tronc x3/jambe','Pistol saut depuis position basse x3','Pistol rebond alterné 10 total x3']},scaled:{movements:[{name:'Hang Power Clean',reps:12,note:'→ 60% 1RM'},{name:'Box Jump',reps:12,note:'→ 50cm step-up'},{name:'Run',reps:1,note:'→ 300m/300m/150m'}],note:'Vitesse sur transitions, ne pas s attarder entre mouvements'},rxPlus:{note:'RX+ HPC @82% + Box 75cm + 500m/500m/250m'}},

{day:62,week:13,name:'HURRICANE',theme:'Puissance Totale — Toutes Filières',haltero:{name:'Snatch',desc:'Snatch complexe — Power snatch + OHS, qualité maximale',scheme:'5x(1 Power Snatch + 2 OHS) @80%',weights:'snatch'},wod:{name:'HURRICANE',type:'For Time',movements:[{name:'Power Snatch',reps:10,weight:'snatch'},{name:'Ring Muscle-Up',reps:5,gymnastics:'muscle_ups_ring'},{name:'Assault Bike',reps:15,special:'assault_bike'},{name:'Power Snatch',reps:8,weight:'snatch'},{name:'Ring Muscle-Up',reps:4,gymnastics:'muscle_ups_ring'},{name:'Assault Bike',reps:15,special:'assault_bike'},{name:'Power Snatch',reps:6,weight:'snatch'},{name:'Ring Muscle-Up',reps:3,gymnastics:'muscle_ups_ring'},{name:'Assault Bike',reps:15,special:'assault_bike'}],notes:'HURRICANE — puissance totale toutes filières semaine 13, WOD signature de fin de phase puissance. Contexte S13 : ce WOD concentre snatch, ring muscle-up et assault bike — les trois mouvements les plus techniques et exigeants du CrossFit. Chaque qualité développée sur 12 semaines est testée simultanément. Power Snatch 75% : chaque rep individuelle avec reset complet si nécessaire — ne pas rater une rep par fatigue technique. Extension hanche complète, tirage haut, glisse sous la barre en position haute. Ring MU 5-4-3 : kipping contrôlé, faux grip maintenu, transition basse vers le dip profond. Engage les hanches au sommet du kip pour créer la montée. Assault Bike 15 cal : sprint 30s effort maximal, récupération partielle pendant les snatchs et ring MU. Pacing : les rounds finaux (6 snatchs + 3 MU + 15 cal) sont le test ultime — c\'est là que tout converge. Respiration : récupérer sur le vélo (bouche ouverte, rythme), pas après l\'arrêt. Vigilance : snatch à la technique imparfaite sous fatigue extrême → stop et reset. Scaling : 65% + bar MU + 12 cal. Cible 16-22 min.'},gym:{name:'Skill: Ring Muscle-Up',drills:['Échauffement false grip 2x10','Ring MU x5 effort modéré','Ring MU + transition slow motion x3','Ring MU complexe: 1 MU + 3 dips x3']},scaled:{movements:[{name:'Power Snatch',reps:10,note:'→ 65% 1RM'},{name:'Ring Muscle-Up',reps:5,note:'→ Bar MU ou 3 Pull-up + 3 Dip'},{name:'Assault Bike',reps:1,note:'→ 12 cal'}],note:'WOD de référence phase — noter le score pour tracking progression'},rxPlus:{note:'RX+ Power Snatch @85% + Ring MU strict x3 + 20 cal Assault Bike'}},
{day:63,week:13,name:'CATACLYSM',theme:'Race Pace + Haltérophilie Lourde',haltero:{name:'Clean & Jerk',desc:'Complex Clean & Jerk – montée progressive vers 1RM journalier',scheme:'1-1-1-1-1',weights:'clean'},wod:{name:'CATACLYSM',type:'AMRAP 18',movements:[{name:'Assault Bike',reps:15,special:'assault_bike'},{name:'Clean',reps:5,weight:'clean'},{name:'Bar Muscle-Up',reps:3,gymnastics:'muscle_ups_bar'},{name:'Wall Ball',reps:10,gymnastics:'wall_ball'}],notes:'CATACLYSM — race pace + haltérophilie lourde semaine 13, format AMRAP Games style. Contexte S13 transition phase : maintenir un rythme compétition dès la première minute. L\'assault bike ouvre les poumons — partir à 85% intensité, observer la fréquence cardiaque et ajuster dès le round 3. Clean 5 reps : touch-and-go si possible, sinon pose contrôlée et tirage rapide. Jamais s\'arrêter plus de 10 secondes entre les reps. Extension hanche complète à chaque rep. Bar Muscle-Up 3 reps : en série non-stop si possible — tirage de hanche vers la barre, transition rapide en dip. Wall Ball 10 reps : rythme régulier, attraper haut, squat profond. Pacing AMRAP 18min : identifier le round critique (souvent round 5-6) et refuser de ralentir à ce moment précis. C\'est la clé de la performance Games. Respiration : rythmée et contrôlée sur le vélo pour récupérer avant les cleans. Vigilance : bar MU sous fatigue = risque d\'épaule — si la transition devient un drag over, passer en C2B. Scaling : 60% clean + jumping BMU + 9kg WB. Cible 6+ rounds complets.'},gym:{name:'Skill: Bar Muscle-Up Efficiency',drills:['Kipping swing strict timing drill – 3x10 swings','False grip pull to hip drill – 3x5','Transition over bar drill – 3x3','Full bar muscle-up singles avec focus poignets – 3x5']},scaled:{movements:[{name:'Assault Bike',reps:12,note:'→ rower 15 cal'},{name:'Clean',reps:5,note:'→ 60% 1RM'},{name:'Bar Muscle-Up',reps:3,note:'→ jumping BMU ou chest-to-bar'},{name:'Wall Ball',reps:10,note:'→ 6kg/9kg'}],note:'Maintenir l\'intention de vitesse même en scaled'},rxPlus:{note:'RX+ Assault Bike 20 cal, Clean 80%1RM, Bar Muscle-Up 5 reps'}},

{day:64,week:13,name:'IRON-ELITE',theme:'Déload Actif – Technique & Mobilité',haltero:{name:'Snatch',desc:'Snatch technique – position basse, turnover, overhead stability',scheme:'3-3-3-3-3',weights:'snatch'},wod:{name:'IRON-ELITE',type:'For Time',movements:[{name:'Run 400m',reps:1,special:'run_400'},{name:'Toes to Bar',reps:21,gymnastics:'toes_to_bar'},{name:'Deadlift',reps:15,weight:'deadlift'},{name:'Double Unders',reps:50,gymnastics:'double_unders'},{name:'Run 400m',reps:1,special:'run_400'},{name:'Toes to Bar',reps:15,gymnastics:'toes_to_bar'},{name:'Deadlift',reps:10,weight:'deadlift'},{name:'Double Unders',reps:50,gymnastics:'double_unders'},{name:'Run 400m',reps:1,special:'run_400'},{name:'Toes to Bar',reps:9,gymnastics:'toes_to_bar'},{name:'Deadlift',reps:5,weight:'deadlift'},{name:'Double Unders',reps:50,gymnastics:'double_unders'}],notes:'IRON-ELITE — déload actif semaine 13, technique et mobilité au programme entre deux phases intenses. Contexte S13 : ce WOD For Time à charge modérée permet de maintenir l\'activation musculaire sans générer de fatigue neuromusculaire. La priorité absolue est la qualité d\'exécution, pas le temps. Course 400m : allure régulière et confortable (5:30-6:00/km), jamais sprinter — la course est le tempo régulateur du WOD. Toes-to-Bar : séries contrôlées 7-7-7 au premier round, 8-7 au deuxième, 9 au troisième. Ne jamais aller à l\'échec musculaire. Maintenir le balancement arrière entre chaque rep. Deadlift à 60% max : dos neutre impeccable à chaque rep. Focus sur la position de départ (omoplates engagées, tête neutre, hanches à la bonne hauteur). DU 50 reps : fluides sans rush, poignets souples. Accélération progressive pendant la série, jamais brusque. Pacing : le troisième round doit être aussi propre que le premier — si vous accélérez sur les 2 premiers, vous compromettez l\'objectif déload. Vigilance : si TTB deviennent des swings sans contrôle, passer aux knees-to-chest. Cible : rythme constant, récupération optimale.'},gym:{name:'Skill: Snatch Positioning',drills:['Snatch balance 5x3 léger – focus stabilité overhead','Overhead squat paused 3sec en bas – 4x5','Pull position drill avec bande – 3x8','Snatch drop drill depuis power position – 3x5']},scaled:{movements:[{name:'Run 400m',reps:1,note:'→ Row 500m'},{name:'Toes to Bar',reps:21,note:'→ knees to chest ou hanging knee raise'},{name:'Deadlift',reps:15,note:'→ 50% 1RM'},{name:'Double Unders',reps:50,note:'→ 100 single unders'}],note:'Déload : priorité à la récupération active et la fluidité'},rxPlus:{note:'RX+ Deadlift 110%BW, Toes to Bar strict, courir en moins de 2min/400m'}},

{day:65,week:13,name:'NEMESIS-ELITE',theme:'Chipper Élite – Mouvements Combinés',haltero:{name:'Front Squat',desc:'Front squat lourd – triples puis double puis single',scheme:'3-3-2-2-1-1',weights:'front_squat'},wod:{name:'NEMESIS-ELITE',type:'For Time',movements:[{name:'Ski Erg',reps:50,special:'ski_erg'},{name:'Squat Clean',reps:10,weight:'squat_clean'},{name:'Handstand Walk',reps:20,gymnastics:'handstand_walk'},{name:'Ski Erg',reps:40,special:'ski_erg'},{name:'Squat Clean',reps:8,weight:'squat_clean'},{name:'Toes to Bar',reps:20,gymnastics:'toes_to_bar'},{name:'Ski Erg',reps:30,special:'ski_erg'},{name:'Squat Clean',reps:6,weight:'squat_clean'},{name:'Ring Muscle-Up',reps:6,gymnastics:'muscle_ups_ring'}],notes:'NEMESIS-ELITE — chipper élite mouvements combinés semaine 13, test complet de toutes les qualités. Contexte phase peak S13 : le chipper est le format le plus exigeant mentalement car chaque section semble interminable. La gestion des ressources dès le départ est la compétence n°1. Ski Erg 50 cal : intensité Games 90%, ne jamais exploser dès le départ — 1 cal toutes les 2 secondes est optimal. Genoux qui poussent, traction des bras complète jusqu\'aux hanches. Squat Clean 10-8-6 : touch-and-go si possible, sinon pose brève et tirage rapide. Inspirer avant chaque rep, expirer à la montée. Handstand Walk 20m : en segments de 5m, regarder les mains (30cm devant), hanches alignées. Si chute, repositionnement immédiat sans frustration. TTB 20 reps : en fin de chipper les avant-bras brûlent — priorité au swing arrière pour économiser la prise. Ring Muscle-Up 6 reps : réserver 20% d\'énergie pour la fin. Pacing stratégique global : sections cardio (ski/bike) permettent récupération partielle avant sections techniques. Vigilance : handstand walk avec épaules fatiguées = risque épaule. Cap 20 minutes. Scaling : réduire volumes de 20%.'},gym:{name:'Skill: Handstand Walk Distance',drills:['Wall handstand hold 3x30sec – focus ligne corporelle','Kick up to wall + shoulder taps – 3x10 taps','Handstand walk 5m segments – 5 passages','Freestanding HS hold 10sec – 5 tentatives']},scaled:{movements:[{name:'Ski Erg',reps:50,note:'→ Row 40 cal'},{name:'Squat Clean',reps:10,note:'→ power clean + front squat séparés'},{name:'Handstand Walk',reps:20,note:'→ bear crawl 20m ou wall walk 5'},{name:'Toes to Bar',reps:20,note:'→ knees to elbow'},{name:'Ring Muscle-Up',reps:6,note:'→ 12 ring dips + 12 pull-ups'}],note:'Réduire les charges de 20%, maintenir les mouvements techniques'},rxPlus:{note:'RX+ Ski Erg sprint max chaque segment, Squat Clean 85%1RM, Ring MU strict'}},

{day:66,week:14,name:'STORM-PEAK',theme:'Benchmark Re-Test – Fran Variante',haltero:{name:'Push Press',desc:'Push press – montée 5-5-3-3-1-1 vers 1RM journalier',scheme:'5-5-3-3-1-1',weights:'push_press'},wod:{name:'STORM-PEAK',type:'For Time',movements:[{name:'Thruster',reps:21,weight:'thruster'},{name:'Pull-Ups',reps:21,gymnastics:'pullups'},{name:'Thruster',reps:15,weight:'thruster'},{name:'Pull-Ups',reps:15,gymnastics:'pullups'},{name:'Thruster',reps:9,weight:'thruster'},{name:'Pull-Ups',reps:9,gymnastics:'pullups'}],notes:'STORM-PEAK — benchmark re-test format Fran avec intention Games, semaine 14. Contexte phase peak S14 : re-tester Fran est l\'un des indicateurs de progression les plus fiables en CrossFit. Votre score aujourd\'hui vs semaine 4 montre l\'impact de l\'entraînement. Thruster Round 21 : séries 12-9 ou 15-6, jamais moins de 6 reps consécutives. Extension hanche complète vers le push press en un seul mouvement fluide. Pull-up Round 21 : butterfly si maîtrisé, kipping sinon. Grand set de 12+ si possible. Round 15 : thrusters en 9-6, pull-ups 10-5. Round 9 : tout d\'une traite — mental pur. La transition thruster→pull-up est la clé absolue : poser la barre, 2 respirations maximum, monter immédiatement. Chaque seconde supplémentaire de repos est perdue pour rien. Pacing : ce WOD doit durer 4-8 minutes — chaque action est maximale. Vigilance : ne pas engager les épaules seules sur le thruster — drive jambes d\'abord. Pull-ups : ne jamais pendre mort entre les reps, garder la tension. Scaling : 65% + bande élastique. Cible sub-4min élite, sub-6min RX solide.'},gym:{name:'Skill: Kipping Pull-Up & Butterfly',drills:['Kipping swing timing 3x15 – rythme régulier','Butterfly pull-up drill 3x5 – entrée et sortie','Combo kipping 5 + butterfly 5 – 3 séries','High-rep pull-up set test 1x max unbroken']},scaled:{movements:[{name:'Thruster',reps:21,note:'→ 65% 1RM ou PVC technique'},{name:'Pull-Ups',reps:21,note:'→ bande élastique ou jumping pull-up'}],note:'Même structure 21-15-9, adapter la charge pour finir en moins de 10min'},rxPlus:{note:'RX+ Thruster 52.5kg/35kg, strict pull-ups, objectif sub-3min'}},

{day:67,week:14,name:'GLADIATOR-ELITE',theme:'Endurance Force – Long AMRAP',haltero:{name:'Hang Clean',desc:'Hang clean – séries courtes lourdes, technique sous fatigue',scheme:'3-3-3-3',weights:'hang_clean'},wod:{name:'GLADIATOR-ELITE',type:'AMRAP 25',movements:[{name:'Assault Bike',reps:20,special:'assault_bike'},{name:'Hang Clean',reps:5,weight:'hang_clean'},{name:'Box Jump',reps:10,gymnastics:'box_jump'},{name:'KB Swing',reps:15,gymnastics:'kb_swing'},{name:'Burpee',reps:8,gymnastics:'burpee'}],notes:'GLADIATOR-ELITE — endurance force longue durée semaine 14, AMRAP 25 minutes type Games day 2. Contexte phase peak S14 : maintenir l\'effort pendant 25 minutes est une compétence différente des WODs courts. La gestion mentale et l\'économie de mouvement priment. Assault Bike 20 cal : 75-80% intensité, objectif 1 minute par passage. Jambes et bras en même temps, rythme métronome. Hang Clean 5 reps : séries non-stop, choisir un poids maintenable sur 25 minutes (jamais plus de 75%). Extension hanche explosive à chaque rep, rack solide. Box Jump 10 reps : step-down obligatoire pour préserver les tendons d\'Achille sur la durée — le rebond est interdit après 15 minutes d\'effort cumulé. KB Swing américain si maîtrisé (overhead), sinon russe. 15 reps à rythme constant. Burpees 8 reps : 3-4 secondes par rep, bras tirés vers le haut à chaque saut. Pacing global : rounds 1-5 à 75%, rounds 6-10 à 80%, rounds 11+ donner ce qu\'il reste. L\'objectif 8+ rounds signifie environ 3min par round. Vigilance : fréquence cardiaque max 85-90%, au-delà = ralentir. Scaling : 15 cal vélo + 55% hang clean + step-up. Cible 8+ rounds.'},gym:{name:'Skill: Box Jump Efficiency & Landing',drills:['Box jump step-down technique – 3x10','Depth jump rebond rapide – 3x8','Lateral box jump – 3x6 chaque côté','Box jump hauteur progressive – 60/70/75/80cm']},scaled:{movements:[{name:'Assault Bike',reps:15,note:'→ rower 15 cal'},{name:'Hang Clean',reps:5,note:'→ 55% 1RM'},{name:'Box Jump',reps:10,note:'→ 50cm ou step-up'},{name:'KB Swing',reps:15,note:'→ russe 24/16kg'},{name:'Burpee',reps:8,note:'→ 6 burpees'}],note:'Maintenir une intensité constante sur les 25 min, ne jamais aller à l\'échec'},rxPlus:{note:'RX+ Assault Bike 25 cal, Hang Clean 80%1RM, Box Jump 75cm, KB Swing américain 32/24kg'}},

{day:68,week:14,name:'WARRIOR',theme:'Haltéro Complexe + Gymnastics Pur',haltero:{name:'Snatch Complex',desc:'Power snatch + snatch balance + overhead squat – complex technique',scheme:'1+1+1 x 5 séries',weights:'snatch'},wod:{name:'WARRIOR',type:'For Time',movements:[{name:'HSPU',reps:30,gymnastics:'hspu'},{name:'Power Clean',reps:15,weight:'power_clean'},{name:'Rope Climb',reps:5,gymnastics:'rope_climb'},{name:'HSPU',reps:20,gymnastics:'hspu'},{name:'Power Clean',reps:12,weight:'power_clean'},{name:'Rope Climb',reps:4,gymnastics:'rope_climb'},{name:'HSPU',reps:10,gymnastics:'hspu'},{name:'Power Clean',reps:9,weight:'power_clean'},{name:'Rope Climb',reps:3,gymnastics:'rope_climb'}],notes:'WARRIOR — complexe haltérophilie + gymnastics pur semaine 14, tripler décroissant HSPU-Clean-Rope. Contexte phase peak S14 : ce WOD teste la capacité à maintenir deux disciplines techniques (HSPU et rope climb) encadrées par des power cleans lourds. HSPU 30-20-10 : gérer les séries dès le début. Kipping ou strictes selon niveau. Round 30 : séries de 10-10-10 maximum. Round 20 : 8-7-5 ou 10-10. Round 10 : unbroken si possible. Tête entre les mains, corps aligné, descent lente contrôlée. Power Clean 15-12-9 : touch-and-go 5 reps max sans respiration, jamais dépasser ce seuil. Tirage explosif, coudes rapides en rack, réception sans choc au sol. Rope Climb : legless si possible (jambes strictement serrées), sinon wrap standard jambe droite. Efficacité de montée est clé — 3 tractions maximum par corde. La transition sol→barre est psychologique : s\'imposer un départ à 10s maximum après chaque section. Pacing : HSPU consomment les épaules — évaluer l\'état des épaules avant chaque série. Vigilance : HSPU avec mauvaise position de cou = blessure cervicale. Scaling : pike push-up + 65% clean + ring rows. Cap 25 minutes.'},gym:{name:'Skill: Strict HSPU Progression',drills:['Pike push-up strict 3x10','Déficit HSPU 5cm – 3x5','Tripod headstand balance 3x20sec','HSPU kipping timing drill 3x5']},scaled:{movements:[{name:'HSPU',reps:30,note:'→ pike push-up ou box HSPU'},{name:'Power Clean',reps:15,note:'→ 65% 1RM'},{name:'Rope Climb',reps:5,note:'→ 3 montées partielles ou 5 ring rows'}],note:'Adapter les déficits et hauteurs pour maintenir la fluidité'},rxPlus:{note:'RX+ HSPU strict déficit 10cm, Power Clean 85%1RM, Rope Climb legless'}},

{day:69,week:14,name:'CAESAR',theme:'Sprint Intervals – Race Pace Pur',haltero:{name:'Shoulder to Overhead',desc:'S2OH lourd – push press / push jerk / split jerk selon feeling',scheme:'5-3-3-1-1-1',weights:'shoulder_to_oh'},wod:{name:'CAESAR',type:'Intervals',movements:[{name:'Run 400m',reps:1,special:'run_400'},{name:'Thruster',reps:10,weight:'thruster'},{name:'Double Unders',reps:30,gymnastics:'double_unders'},{name:'Toes to Bar',reps:10,gymnastics:'toes_to_bar'}],notes:'CAESAR — sprint intervals race pace pur semaine 14, 5 rounds de 4 minutes avec 1 minute de repos actif. Contexte phase peak S14 : les intervalles à intensité maximale développent la capacité à répéter des efforts de haute intensité — compétence clé en compétition CrossFit. Run 400m : allure 90-95%, objectif 1min30-1min45 selon niveau. Pas de jogging sous prétexte de gérer l\'effort — chaque 400m est un sprint contrôlé. Thruster 10 reps : unbroken obligatoire, choisir la charge permettant cela sur 5 rounds (typiquement 65-70% 1RM). Extension hanche vers push press en un seul mouvement. DU 30 reps : unbroken si possible, corde à rythme régulier. TTB 5-5 ou unbroken. La minute de repos est active (marcher, respiration naso-buccale). Splits stratégie : noter le temps de chaque round, viser la régularité à ±15 secondes entre rounds. Round 1 le plus rapide n\'est pas la bonne stratégie — round 3 doit égaler round 1. Vigilance : si run 400m dépasse 2 minutes, le poids thruster est trop lourd. Pacing correct : 1min30 run + 30s thrusters + 20s DU + 20s TTB = 3min20, 40s de marge. Cible : 5 rounds équidistants.'},gym:{name:'Skill: Double Unders Consistency',drills:['Single under rythme régulier 1x50','DU 10 consécutifs – 5 passages','DU 30 consécutifs – 3 passages','DU 50+ non-stop – objectif personnel']},scaled:{movements:[{name:'Run 400m',reps:1,note:'→ Row 500m'},{name:'Thruster',reps:10,note:'→ 65% 1RM'},{name:'Double Unders',reps:30,note:'→ 60 single unders'},{name:'Toes to Bar',reps:10,note:'→ knees to chest'}],note:'Maintenir l\'intention sprint à chaque intervalle'},rxPlus:{note:'RX+ Run 400m sous 1min40, Thruster 43kg/29kg, DU 50 reps par round'}},

{day:70,week:14,name:'MAXIMUS',theme:'Chipper Games – Test Complet',haltero:{name:'Back Squat',desc:'Back squat lourd – montée vers 3RM puis 1RM journalier',scheme:'5-3-3-1-1',weights:'back_squat'},wod:{name:'MAXIMUS',type:'For Time',movements:[{name:'Ski Erg',reps:80,special:'ski_erg'},{name:'Deadlift',reps:30,weight:'deadlift'},{name:'Wall Ball',reps:40,gymnastics:'wall_ball'},{name:'Assault Bike',reps:30,special:'assault_bike'},{name:'Pull-Ups',reps:30,gymnastics:'pullups'},{name:'Overhead Squat',reps:20,weight:'overhead_squat'},{name:'Burpee',reps:20,gymnastics:'burpee'},{name:'Rope Climb',reps:4,gymnastics:'rope_climb'}],notes:'MAXIMUS — chipper Games test complet semaine 14, 8 sections d\'endurance mentale et physique. Contexte phase peak S14 : simuler la réalité d\'un chipper Open ou Games Day 3 où tout le corps est déjà épuisé. Ski Erg 80 cal : en 2 segments 40+40, effort 80%, 1 cal/2s. Ne jamais aller à fond — vous devez tenir encore 7 sections. Deadlift 30 reps : séries de 10-10-10, dos neutre impeccable, jamais de fatigue lombaire. Wall Ball 40 reps : 10-10-10-10 réguliers, attraper haut, squat profond. Assault Bike 30 cal : 80%, récupération partielle des jambes. Pull-ups 30 reps : séries de 10 butterfly ou kipping, ne jamais pendre mort. OHS 20 reps : choisir un poids maîtrisable (60% 1RM snatch), technique impeccable — les épaules seront fatiguées à ce stade. Burpee 20 reps : 5 par minute rythmique, ne jamais s\'accroupir trop longtemps au sol. Rope Climb 4 montées : efficace 3+1 ou 2+2, trois tractions par montée. Pacing global : ce chipper est gagné à la section OHS et rope climb — réserver 20% d\'énergie pour la fin. Vigilance : OHS avec épaules fatiguées → réduire charge immédiatement. Cap 35 minutes.'},gym:{name:'Skill: Overhead Squat Stability',drills:['OHS avec PVC – 3x10 paused 3sec en bas','OHS avec barre vide – 3x8 slow tempo','Snatch grip press behind neck – 3x10','OHS 60% – 3x5 avec focus genoux-orteils']},scaled:{movements:[{name:'Ski Erg',reps:60,note:'→ Row 50 cal'},{name:'Deadlift',reps:30,note:'→ 60% 1RM'},{name:'Wall Ball',reps:30,note:'→ 6kg/9kg'},{name:'Assault Bike',reps:20,note:'→ Row 20 cal'},{name:'Pull-Ups',reps:30,note:'→ bande élastique'},{name:'Overhead Squat',reps:20,note:'→ PVC ou barre vide'},{name:'Burpee',reps:15,note:'→ 15 burpees'},{name:'Rope Climb',reps:4,note:'→ 8 ring rows'}],note:'Réduire volumes et charges pour finir en moins de 40 min'},rxPlus:{note:'RX+ Ski Erg sprint, Deadlift 100%BW, OHS 60%1RM snatch, Rope Climb legless'}},

{day:71,week:15,name:'THUNDER',theme:'Déload Semaine 15 – Activation Compétition',haltero:{name:'Clean',desc:'Clean technique déload – hang position, vitesse sous la barre',scheme:'3-3-3 à 70%',weights:'clean'},wod:{name:'THUNDER',type:'AMRAP 20',movements:[{name:'Run 200m',reps:1,special:'run_200'},{name:'KB Swing',reps:10,gymnastics:'kb_swing'},{name:'Box Jump',reps:8,gymnastics:'box_jump'},{name:'Pull-Ups',reps:6,gymnastics:'pullups'}],notes:'THUNDER — déload activation semaine 15, dernière semaine avant la phase competition. Contexte S15 : cette semaine de déload est critique — trop d\'intensité ici ruine la fraîcheur pour les WODs compétition des jours 76-100. L\'objectif est l\'activation musculaire et articulaire, pas la performance. Run 200m : allure 65% (environ 1min10-1min20), jamais sprint. La course est un réveil musculaire, pas un effort. KB Swing russe : charge légère (16/12kg), hanches explosives, geste rapide et fluide. Box Jump : hauteur standard, focus sur la réception souple et l\'efficacité du rebond. Préserver les tendons. Pull-ups kipping fluides : 6 reps régulières, pas d\'effort maximal. Pacing AMRAP 20min : ce WOD doit laisser la sensation de pouvoir recommencer à la fin — si vous êtes épuisé à la fin, vous êtes allé trop vite. Test simple : parler normalement pendant l\'effort doit être possible. Vigilance : si fréquence cardiaque dépasse 80% max, ralentir immédiatement — déload signifie vraiment déload. Ne pas écouter l\'ego qui veut performer. Mobilité active entre chaque round recommandée. Scaling : tout réduire encore plus — l\'intensité n\'est jamais la priorité en déload. Cible 12-14 rounds en 20 minutes.'},gym:{name:'Skill: Activation & Mobilité Compét',drills:['Hip flexor stretch 2x90sec chaque côté','Thoracique mobilisation sur foam roller 2x2min','Shoulder CARs – 2x10 rotations contrôlées','Activation fessiers – clamshell 2x15 + pont 2x15']},scaled:{movements:[{name:'Run 200m',reps:1,note:'→ Row 250m'},{name:'KB Swing',reps:10,note:'→ 12/8kg russe'},{name:'Box Jump',reps:8,note:'→ 45cm step-up'},{name:'Pull-Ups',reps:6,note:'→ bande légère'}],note:'Déload total : écouter le corps, stopper si douleur articulaire'},rxPlus:{note:'RX+ Run 200m sous 50sec, KB Swing américain 32/24kg, Box Jump 75cm'}},

{day:72,week:15,name:'ZEUS',theme:'Benchmark Classique – Re-Test Cindy/Jackie',haltero:{name:'Power Clean',desc:'Power clean – activation compétition, 5 séries de 3 à 75-80%',scheme:'3-3-3-3-3',weights:'power_clean'},wod:{name:'ZEUS',type:'For Time',movements:[{name:'Row',reps:1000,special:'row_cal'},{name:'Thruster',reps:50,weight:'thruster'},{name:'Pull-Ups',reps:30,gymnastics:'pullups'}],notes:'ZEUS — benchmark re-test Jackie modifié semaine 15, indicateur direct de progression depuis le début du programme. Contexte S15 : comparer ce score avec votre performance des premières semaines. La différence est la preuve de 15 semaines de travail. Row 1000m : allure soutenue mais pas sprint. Target 3min30-4min selon niveau. Économiser les bras pour les thrusters — ne pas tirer uniquement avec les bras, le drive vient des jambes. Thruster 50 reps : le piège classique de Jackie. JAMAIS tomber en dessous de 7 reps par série. Séquence suggérée : 10-10-10-10-10 ou 12-10-10-10-8. Le drop sous 7 reps signifie que vous êtes parti trop fort sur le row. Transition row→barre : 5 secondes maximum, ne pas hésiter. Extension hanche complète sur chaque thruster. Pull-ups 30 reps : 10-10-10 butterfly ou kipping. Jamais pendre mort entre les reps. Butterfly économise 20-30% d\'énergie vs kipping sur ce volume. Pacing : Row 4min + Thrusters 4-5min + Pull-ups 1-2min = 9-11min total idéal. Vigilance : si thrusters deviennent des strict press, les jambes sont mortes — réduire la charge et accélérer la course suivante. Cible sub-9min élite, sub-12min RX.'},gym:{name:'Skill: Row Technique Race Pace',drills:['Row 10x100m avec 30sec récup – focus drive','Row catch position drill – 3x2min focus','Sprints row 10sec tous les 1min – 8 rounds','Row 500m à allure cible compétition – 1 passage']},scaled:{movements:[{name:'Row',reps:1000,note:'→ Row 750m'},{name:'Thruster',reps:50,note:'→ 65% 1RM'},{name:'Pull-Ups',reps:30,note:'→ bande élastique'}],note:'Maintenir le format Jackie original, adapter la charge uniquement'},rxPlus:{note:'RX+ Row 1000m sub-3min30, Thruster 52.5kg/35kg, strict pull-ups'}},

{day:73,week:15,name:'KRONOS',theme:'Complex Élite – Mouvements Compétition',haltero:{name:'Squat Clean Thruster',desc:'Squat clean + thruster complex – 1+1 par série, lourd progressif',scheme:'1+1 x 6 montée',weights:'squat_clean'},wod:{name:'KRONOS',type:'For Time',movements:[{name:'Assault Bike',reps:25,special:'assault_bike'},{name:'Squat Clean',reps:7,weight:'squat_clean'},{name:'Ring Muscle-Up',reps:5,gymnastics:'muscle_ups_ring'},{name:'Ski Erg',reps:25,special:'ski_erg'},{name:'Squat Clean',reps:6,weight:'squat_clean'},{name:'Ring Muscle-Up',reps:5,gymnastics:'muscle_ups_ring'},{name:'Assault Bike',reps:20,special:'assault_bike'},{name:'Squat Clean',reps:5,weight:'squat_clean'},{name:'Ring Muscle-Up',reps:5,gymnastics:'muscle_ups_ring'}],notes:'KRONOS — complex élite mouvements compétition semaine 15, WOD de sélection niveau Games. Contexte phase peak S15 : ce WOD reproduit exactement la structure d\'un WOD CrossFit Games — cardio machine, haltérophilie lourde, gymnastics avancé, répété sur 3 rounds décroissants. Assault Bike 25-20 cal : 90% intensité dès le départ. Jambes et bras ensemble, rythme explosif. Objectif <50s pour 25 cal, <40s pour 20 cal. Squat Clean 7-6-5 : touch-and-go si possible. Position basse immédiate à la réception, extension explosive du bas du squat. Jamais laisser les hanches monter avant les épaules. Ring MU 5 reps (x3 rounds) : faux grip maintenu, transition fluide, penser à s\'élever haut sur le kipping avant la transition. Ski Erg 25 cal : sprint contrôlé entre les sections. L\'alternance cardio-haltéro-gymnastic est l\'essence du CrossFit Games — simuler exactement cette réalité mentale. Pacing : pas de repos inutile, maximum 10 secondes entre sections. Le chrono est le seul juge. Vigilance : ring MU sous fatigue extrême — si transition compromise, passer en C2B. Scaling : 20 cal vélo + power clean + pull-up + dip. Cap 22 minutes.'},gym:{name:'Skill: Ring Muscle-Up Kipping',drills:['Ring support position 3x20sec – focus retournement','Kipping swing aux anneaux 3x10','Transition drill anneaux bas 3x5','Ring muscle-up singles avec focus extension hanche']},scaled:{movements:[{name:'Assault Bike',reps:20,note:'→ Row 20 cal'},{name:'Squat Clean',reps:7,note:'→ power clean + front squat'},{name:'Ring Muscle-Up',reps:5,note:'→ 10 pull-ups + 10 ring dips'},{name:'Ski Erg',reps:20,note:'→ Row 20 cal'}],note:'Maintenir l\'alternance cardio-force-gymnastic dans la structure'},rxPlus:{note:'RX+ Assault Bike 30 cal, Squat Clean 85%1RM, Ring MU strict, Ski Erg 30 cal'}},

{day:74,week:15,name:'ARES',theme:'Endurance Ultime – Simulation Games Day',haltero:{name:'Overhead Squat',desc:'OHS lourd – 5-5-3-3-1 montée vers maximum du jour',scheme:'5-5-3-3-1',weights:'overhead_squat'},wod:{name:'ARES',type:'For Time',movements:[{name:'Run 800m',reps:1,special:'run_800'},{name:'Deadlift',reps:21,weight:'deadlift'},{name:'HSPU',reps:21,gymnastics:'hspu'},{name:'Run 800m',reps:1,special:'run_800'},{name:'Deadlift',reps:15,weight:'deadlift'},{name:'HSPU',reps:15,gymnastics:'hspu'},{name:'Run 800m',reps:1,special:'run_800'},{name:'Deadlift',reps:9,weight:'deadlift'},{name:'HSPU',reps:9,gymnastics:'hspu'}],notes:'ARES — endurance ultime simulation Games Day semaine 15, le WOD le plus long de la phase avant le final. Contexte S15 : 3 rounds de 800m + DL + HSPU testent la capacité à maintenir la technique sur une durée de 28-35 minutes. C\'est un test d\'athlète complet. Run 800m stratégie progressive : round 1 à 80% (2min50-3min), round 2 à 85% (2min40-2min50), round 3 à 90%+ (2min30-2min40). Progression inversée rare mais psychologiquement puissante. Deadlift 21-15-9 : séries de 7-7-7, 8-7, 9. Dos neutre impeccable même à la 7ème rep. Jamais de fatigue lombaire — c\'est la règle absolue. Inspirer avant chaque série. HSPU 21-15-9 : kipping ou strictes selon niveau. Round 1 en 10-6-5 maximum. Round 2 en 8-7. Round 3 en 9 unbroken si les épaules tiennent. Pacing global : la deuxième course est psychologiquement la plus dure — elle définit les athlètes d\'élite. Refuser de marcher. Troisième course = finale, tout donner. Vigilance : si HSPU dégradent avec la tête basse et dos courbé, arrêter et faire pike push-ups. Scaling : row 1000m + 60% DL + box HSPU. Cible sub-28min élite, sub-35min RX.'},gym:{name:'Skill: Run 800m Pacing Strategy',drills:['Run 400m x4 avec récup 2min – noter splits','Cadence drill 180 pas/min – 2x400m','Hill run simulation – 2x200m montée/descente','Stride drill 6x50m accélération progressive']},scaled:{movements:[{name:'Run 800m',reps:1,note:'→ Row 1000m'},{name:'Deadlift',reps:21,note:'→ 60% 1RM'},{name:'HSPU',reps:21,note:'→ pike push-up ou box HSPU'}],note:'Réduire le volume de 30% si récupération insuffisante en semaine 15'},rxPlus:{note:'RX+ Run 800m sub-3min30, Deadlift 120%BW, HSPU strict déficit 10cm'}},

{day:75,week:15,name:'POSEIDON',theme:'Final Phase – Peak Performance Test',haltero:{name:'Clean & Jerk',desc:'Clean & Jerk – test 1RM final de phase, tout donner',scheme:'1-1-1-1-1 montée max',weights:'clean'},wod:{name:'POSEIDON',type:'For Time',movements:[{name:'Assault Bike',reps:30,special:'assault_bike'},{name:'Snatch',reps:10,weight:'snatch'},{name:'Toes to Bar',reps:20,gymnastics:'toes_to_bar'},{name:'Double Unders',reps:50,gymnastics:'double_unders'},{name:'Assault Bike',reps:25,special:'assault_bike'},{name:'Snatch',reps:8,weight:'snatch'},{name:'Toes to Bar',reps:15,gymnastics:'toes_to_bar'},{name:'Double Unders',reps:50,gymnastics:'double_unders'},{name:'Assault Bike',reps:20,special:'assault_bike'},{name:'Snatch',reps:6,weight:'snatch'},{name:'Toes to Bar',reps:10,gymnastics:'toes_to_bar'},{name:'Double Unders',reps:50,gymnastics:'double_unders'}],notes:'POSEIDON — WOD final de la phase Compétition semaine 15, test absolu de toutes les qualités développées sur 15 semaines. Ce WOD est un marqueur : comparer chaque section avec vos performances des semaines 1-4. La progression visible est la preuve concrète du travail accompli. Assault Bike 30-25-20 cal : à intensité maximale dès le départ — c\'est la dernière séquence de cette phase, tout donner sur chaque passage. Snatch 10-8-6 : technique parfaite même sous fatigue maximale. Les positions (extension hanche, tirage haut, reception overhead stable) priment sur la vitesse. Une rep technique parfaite > deux reps bâclées. Toes-to-Bar 20-15-10 : grand set dès que possible sur chaque tranche. TTB strict ou kipping selon niveau — maintenir le swing arrière. DU 50 reps x3 : 50 reps sans faute, concentration maximale. Ralentir si besoin pour ne pas repartir de zéro. Pacing For Time : les 3 rounds sont décroissants en volume — le dernier round doit être le plus rapide. Respiration : les vélos permettent de récupérer partiellement avant les snatchs. Vigilance : snatch sous fatigue extrême → une seule mauvaise réception peut blesser l\'épaule. Réduire à power snatch si nécessaire. Célébrer chaque répétition. Cap 30 minutes.'},gym:{name:'Skill: Snatch Under Fatigue',drills:['Snatch grip deadlift 5x3 – renforcement positions','Hang power snatch 3x5 à 60% – vitesse coudes','Snatch balance 4x3 – confiance overhead','Full snatch 70% x5 singles – application finale']},scaled:{movements:[{name:'Assault Bike',reps:20,note:'→ Row 20 cal'},{name:'Snatch',reps:10,note:'→ 60% 1RM power snatch'},{name:'Toes to Bar',reps:20,note:'→ knees to chest'},{name:'Double Unders',reps:50,note:'→ 100 single unders'}],note:'WOD final : donner 100% à son niveau, c\'est l\'intensité relative qui compte'},rxPlus:{note:'RX+ Assault Bike sprint 90sec max, Snatch 80%1RM, Toes to Bar strict, DU unbroken'}},
{
...
},
{
  ...
  wod: { name: 'WARDOG', type: 'For Time (cap 22min)', movements: [
    ...
    {name: 'Thrusters', reps: 9, weight: 'thruster'},
    {name: 'Bar Muscle-ups', reps: 6, gymnastics: 'muscle_ups_bar'}
  ], notes: 'WARDOG — Note : les Back Squats ont été remplacés par des Thrusters (60/42.5kg) car la séance haltérophilie du jour comprend déjà un Back Squat 1RM absolu. Cumuler 45 Back Squats dans le WOD après un 1RM constitue un overload dangereux pour le système nerveux et les genoux. Les Thrusters (thruster = front squat + push press) maintiennent le pattern de flexion profonde et l\'intensité du WOD avec une charge réduite à 60/42.5kg. 21 reps en 7-7-7. 15 reps en 5-5-5. 9 reps unbroken. Technique thruster : squat complet cuisse sous parallèle, hanche explosive, push press dans le même élan, lockout complet. BMU : séries de 3-3-3-3 ou 4-4-4 selon niveau. Vigilance : ne jamais faire ce WOD si les genoux sont déjà fatigués du 1RM BS. Sub 17min = guerrier. Chaque rep renforce pour Day 100.' },
  ...
  scaled: { movements: [{name: 'Thrusters', reps: 21, note: '40/27.5kg ou 15 reps si jambes épuisées après BS 1RM'}, {name: 'Bar Muscle-ups', reps: 12, note: '20 C2B ou 24 kipping'}, {name: 'Bar Muscle-ups', reps: 9, note: '15 C2B ou banded BMU'}], note: 'Scaling: réduire charge thruster si jambes fatiguées du 1RM BS. Finir sous le cap.' },
  rxPlus: { note: 'RX+: Thrusters @70kg/47.5kg. BMU strict tous sets. Target sub 14min. Dernier boss avant taper.' }
},
// ============ WEEK 20 — TAPER + PEAK ============
