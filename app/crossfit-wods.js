...
},
{
  ...
  ], notes: 'BENCHMARK HELEN — Test tri-modal classique (cardio + KB + gymnastics). Stratégie: 1er 400m à 85% (évitez le sprint, vous avez 3 runs!). KB 21 unbroken americains (poussez les hanches, bras passifs). Pull-ups kipping 12 unbroken ou 8-4. Le 3ème round = accélérez le 400m. Respirez par la bouche uniquement sur les KB (rythme forcé). Standards CrossFit Games. Élite H sub 9:00 / F sub 10:30. Avancé H sub 11:00 / F sub 12:30. ⚠️ NOTEZ votre score — vous re-testerez en S8, S12 et S16! (S20 = ARMAGEDDON finale)' },
...
},
{
  ...
  scaled: { movements: [{name: 'Pull-ups', reps: 100, note: '→ Ring rows ou banded pull-ups'}, {name: 'Push-ups', reps: 200, note: '→ Genoux au sol si nécessaire'}, {name: 'Run', note: '→ Row 1500m ou marche rapide si blessure'}], note: 'Première fois: Réduire à 50/100/150 (demi-Murph). Partitionnez librement. Respectez les standards de mouvements. Weight vest = JAMAIS la première fois — construire la base d\'abord.' },
  rxPlus: { note: 'RX+ Murph: Weight vest 9/6 kg obligatoire (uniquement athlètes confirmés avec historique Murph sans vest). Pull-ups = unbroken par 5 toujours. Courir les 2 miles à >85% effort. Target H sub 32min / F sub 40min.' }
},
