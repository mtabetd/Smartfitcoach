...
var EXERCISE_ALTERNATIVES = {
  ...
  quadriceps: [
    ...
    { n: 'Sissy squat', m: 'Quadriceps', eq: 'Poids de corps', sets: '3×12-15', rest: '60s', lv: 3 },
  ...
  fessiers: [
    ...
    { n: 'Frog pump', m: 'Grand fessier', eq: 'Poids de corps', sets: '3×15-20', rest: '30s', lv: 1 },
    { n: 'Sumo squat haltere', m: 'Fessiers / Adducteurs', eq: 'Haltere', sets: '4×10-12', rest: '90s', lv: 1 },
  ...
  abdos: [
    ...
    { n: 'Dead bug', m: 'Abdominaux / Core', eq: 'Poids de corps', sets: '3×10-12', rest: '60s', lv: 1 },
    { n: 'L-sit', m: 'Abdominaux / Core', eq: 'Barres parallèles', sets: '3×20-30s', rest: '60s', lv: 3 },
    { n: 'Hollow body hold', m: 'Abdominaux / Core', eq: 'Poids de corps', sets: '3×30-45s', rest: '60s', lv: 2 },
