...
var EXERCISE_ALTERNATIVES = {
  pectoraux: [
    { n: 'Développé couché', m: 'Pectoraux', eq: 'Barre + banc', sets: '4×8-12', rest: '90s', lv: 2 },
    { n: 'Développé haltères couché', m: 'Pectoraux', eq: 'Haltères + banc', sets: '4×10-12', rest: '90s', lv: 1 },
    { n: 'Développé incliné haltères', m: 'Pectoraux supérieurs', eq: 'Haltères + banc incliné', sets: '3×10-12', rest: '75s', lv: 1 },
    { n: 'Pompes classiques', m: 'Pectoraux', eq: 'Poids du corps', sets: '4×15-20', rest: '60s', lv: 1 },
    { n: 'Pompes déclinées', m: 'Pectoraux supérieurs', eq: 'Poids du corps', sets: '3×12-15', rest: '60s', lv: 1 },
    { n: 'Écarté haltères couché', m: 'Pectoraux', eq: 'Haltères + banc', sets: '3×12-15', rest: '60s', lv: 1 },
    { n: 'Câble crossover bas', m: 'Pectoraux inférieurs', eq: 'Câble poulie basse', sets: '3×12-15', rest: '60s', lv: 2 },
    { n: 'Dips prise large', m: 'Pectoraux / Triceps', eq: 'Barres parallèles', sets: '3×10-15', rest: '90s', lv: 2 },
    { n: 'Chest press machine', m: 'Pectoraux', eq: 'Machine convergente', sets: '3×12-15', rest: '60s', lv: 1 },
    { n: 'Câble crossover', m: 'Pectoraux', eq: 'Câble double poulie', sets: '3×12-15', rest: '60s', lv: 2 },
    { n: 'Pec deck / Butterfly', m: 'Pectoraux', eq: 'Machine pec deck', sets: '3×12-15', rest: '60s', lv: 1 },
    { n: 'Landmine press', m: 'Pectoraux', eq: 'Barre landmine', sets: '4×10-12', rest: '90s', lv: 2 },
    { n: 'Développé incliné barre', m: 'Pectoraux supérieurs', eq: 'Barre + banc incliné', sets: '4×8-12', rest: '90s', lv: 2 },
    { n: 'Développé décliné barre', m: 'Pectoraux inférieurs', eq: 'Barre + banc décliné', sets: '4×8-10', rest: '90s', lv: 3 },
    { n: 'Écarté câble poulie haute', m: 'Pectoraux inférieurs', eq: 'Câble double poulie haute', sets: '3×12-15', rest: '60s', lv: 2 },
    { n: 'Pompes prise large', m: 'Pectoraux', eq: 'Poids du corps', sets: '4×15-25', rest: '60s', lv: 1 },
    { n: 'Chest press unilatéral câble', m: 'Pectoraux', eq: 'Câble basse poulie', sets: '3×12-15', rest: '60s', lv: 2 },
    { n: 'Développé couché haltère unilatéral', m: 'Pectoraux', eq: 'Haltère + banc', sets: '4×10-12', rest: '75s', lv: 2 },
    { n: 'Pompes archer', m: 'Pectoraux (unilatéral)', eq: 'Poids du corps', sets: '4×8-10', rest: '75s', lv: 3 },
    { n: 'Écarté câble poulie basse (crossover haut)', m: 'Pectoraux supérieurs', eq: 'Câble double poulie basse', sets: '3×12-15', rest: '60s', lv: 2 }
  ],
  dos: [
    { n: 'Tractions pronation', m: 'Grand dorsal', eq: 'Barre de traction', sets: '4×6-10', rest: '120s', lv: 2 },
    { n: 'Chin-ups (traction supination)', m: 'Grand dorsal / Biceps', eq: 'Barre de traction', sets: '4×6-10', rest: '120s', lv: 2 },
    { n: 'Tirage vertical prise large', m: 'Dos (largeur)', eq: 'Machine / Poulie haute', sets: '4×10', rest: '90s', lv: 1 },
    { n: 'Tirage horizontal câble', m: 'Dorsaux / Rhomboïdes', eq: 'Câble horizontal', sets: '4×10-12', rest: '90s', lv: 1 },
    { n: 'Rowing haltère unilatéral', m: 'Grand dorsal / Trapèzes', eq: 'Haltère + banc', sets: '4×10-12', rest: '75s', lv: 1 },
    { n: 'Rowing barre', m: 'Grand dorsal / Trapèzes', eq: 'Barre', sets: '4×8-12', rest: '90s', lv: 2 },
    { n: 'Pendlay row', m: 'Grand dorsal / Rhomboïdes', eq: 'Barre', sets: '4×6-8', rest: '120s', lv: 3 },
    { n: 'Chest supported row', m: 'Dos', eq: 'Banc incliné + haltères', sets: '4×10-12', rest: '90s', lv: 1 },
    { n: 'Straight arm pulldown câble', m: 'Dos', eq: 'Câble haute poulie', sets: '3×12-15', rest: '60s', lv: 2 },
    { n: 'Rack pull', m: 'Dos', eq: 'Barre + rack', sets: '4×6-8', rest: '120s', lv: 3 },
    { n: 'Tirage vertical prise neutre V-bar', m: 'Dos (largeur)', eq: 'Câble haute poulie + V-bar', sets: '4×10-12', rest: '90s', lv: 1 },
    { n: 'Seal row', m: 'Grand dorsal / Trapèzes', eq: 'Banc plat surélevé + barre', sets: '4×8-12', rest: '90s', lv: 2 },
    { n: 'Traction lestée', m: 'Grand dorsal', eq: 'Barre de traction + ceinture de lest', sets: '5×4-8', rest: '120s', lv: 3 },
    { n: 'Traction prise très large', m: 'Grand dorsal / Dentelé antérieur', eq: 'Barre de traction', sets: '4×6-8', rest: '120s', lv: 3 },
    { n: 'Rowing Pendlay prise large', m: 'Rhomboïdes / Trapèzes moyens', eq: 'Barre', sets: '4×5-8', rest: '120s', lv: 3 },
    { n: 'Yates row', m: 'Grand dorsal / Biceps', eq: 'Barre', sets: '4×8-10', rest: '90s', lv: 2 },
    { n: 'Rowing haltère prise neutre', m: 'Grand dorsal / Rhomboïdes', eq: 'Haltère + banc', sets: '4×10-12', rest: '75s', lv: 1 },
    { n: 'Pull-over haltère couché', m: 'Grand dorsal / Dentelé antérieur', eq: 'Haltère + banc', sets: '3×12-15', rest: '75s', lv: 2 },
    { n: 'Rowing machine unilatéral', m: 'Grand dorsal / Rhomboïdes', eq: 'Machine rowing', sets: '4×10-12', rest: '75s', lv: 1 },
    { n: 'Traction élastique assistée', m: 'Grand dorsal', eq: 'Barre de traction + élastique', sets: '4×8-12', rest: '90s', lv: 1 }
  ],
  epaules: [
    { n: 'Développé militaire barre', m: 'Épaules', eq: 'Barre', sets: '4×8-12', rest: '90s', lv: 2 },
    { n: 'Développé haltères assis', m: 'Épaules', eq: 'Haltères + banc', sets: '4×10-12', rest: '75s', lv: 1 },
    { n: 'Élévations latérales', m: 'Deltoïde latéral', eq: 'Haltères', sets: '4×12-15', rest: '60s', lv: 1 },
    { n: 'Élévations frontales', m: 'Deltoïde antérieur', eq: 'Haltères', sets: '3×12-15', rest: '60s', lv: 1 },
    { n: 'Oiseau haltères', m: 'Deltoïde postérieur', eq: 'Haltères', sets: '4×12-15', rest: '60s', lv: 1 },
        { n: 'Face pull poulie haute', m: 'Deltoïde postérieur + rotateurs', eq: 'Câble + corde', sets: '4×15', rest: '60s', lv: 1 },
    { n: 'Arnold press', m: 'Épaules (3 chefs)', eq: 'Haltères', sets: '3×10-12', rest: '75s', lv: 2 },
    { n: 'Tirage menton', m: 'Deltoïde / Trapèzes', eq: 'Barre ou câble', sets: '3×12', rest: '60s', lv: 2 },
    { n: 'Développé militaire machine', m: 'Épaules', eq: 'Machine épaules', sets: '3×12-15', rest: '60s', lv: 1 },
    { n: 'Élévations latérales câble', m: 'Deltoïde latéral', eq: 'Câble basse poulie', sets: '3×15-20', rest: '30s', lv: 2 },
    { n: 'Rotation externe élastique', m: 'Épaules (coiffe)', eq: 'Élastique', sets: '3×15-20', rest: '30s', lv: 1 },
    { n: 'Upright row câble', m: 'Deltoïde / Trapèzes', eq: 'Câble basse poulie', sets: '4×10-12', rest: '60s', lv: 2 },
    { n: 'Développé haltères debout', m: 'Épaules', eq: 'Haltères', sets: '4×10-12', rest: '75s', lv: 2 },
    { n: 'Élévations latérales élastique', m: 'Deltoïde latéral', eq: 'Élastique', sets: '4×15-20', rest: '45s', lv: 1 },
    { n: 'Oiseau poulie câble', m: 'Deltoïde postérieur', eq: 'Câble double poulie haute', sets: '3×15', rest: '45s', lv: 2 },
    { n: 'Rotation externe haltère (coude appuyé)', m: 'Coiffe des rotateurs', eq: 'Haltère + banc', sets: '3×15-20', rest: '30s', lv: 1 },
    { n: 'Développé militaire barre nuque', m: 'Épaules / Deltoïde latéral', eq: 'Barre + rack', sets: '4×8-10', rest: '90s', lv: 3 },
    { n: 'Scarecrow haltères', m: 'Deltoïde postérieur / Coiffe', eq: 'Haltères', sets: '3×12-15', rest: '45s', lv: 2 },
    { n: 'Élévations frontales câble', m: 'Deltoïde antérieur', eq: 'Câble basse poulie', sets: '3×12-15', rest: '45s', lv: 2 },
    { n: 'Push press barre', m: 'Épaules (puissance)', eq: 'Barre', sets: '4×5-8', rest: '120s', lv: 3 }
  ],
  biceps: [
    { n: 'Curl barre droite', m: 'Biceps', eq: 'Barre', sets: '4×10-12', rest: '60s', lv: 1 },
    { n: 'Curl haltères alterné', m: 'Biceps / Brachial', eq: 'Haltères', sets: '4×10-12', rest: '60s', lv: 1 },
    { n: 'Curl marteau', m: 'Brachioradial / Biceps', eq: 'Haltères', sets: '3×12', rest: '60s', lv: 1 },
    { n: 'Curl incliné haltères', m: 'Biceps chef long', eq: 'Haltères + banc incliné', sets: '3×10-12', rest: '60s', lv: 2 },
    { n: 'Curl pupitre (scott curl)', m: 'Biceps chef court', eq: 'Barre + pupitre', sets: '3×10-12', rest: '60s', lv: 1 },
    { n: 'Curl câble basse poulie', m: 'Biceps', eq: 'Câble bas', sets: '3×12-15', rest: '60s', lv: 1 },
    { n: 'Curl concentré', m: 'Biceps (peak)', eq: 'Haltère', sets: '3×12-15', rest: '45s', lv: 1 },
    { n: 'Curl EZ barre', m: 'Biceps', eq: 'Barre EZ', sets: '4×10-12', rest: '60s', lv: 1 },
    { n: 'Curl spider (araignee)', m: 'Biceps (pic)', eq: 'Barre EZ ou haltères + banc incliné', sets: '3×10-12', rest: '60s', lv: 2 },
    { n: 'Curl marteau câble', m: 'Brachial / Brachio-radial', eq: 'Câble poulie basse + corde', sets: '3×12-15', rest: '60s', lv: 1 },
    { n: 'Curl barre supination 3/4 amplitude', m: 'Biceps (chef court / contraction maximale)', eq: 'Barre droite', sets: '3×12-15', rest: '60s', lv: 2 },
    { n: 'Curl 21s', m: 'Biceps (complet)', eq: 'Barre EZ ou halteres', sets: '3×21 (7+7+7)', rest: '90s', lv: 2 },
    { n: 'Bayesian curl câble', m: 'Biceps (chef long)', eq: 'Câble poulie basse', sets: '3×10-15', rest: '60s', lv: 2 },
    { n: 'Curl pupitre haltère unilatéral', m: 'Biceps (chef court)', eq: 'Haltère + banc preacher', sets: '3×10-12', rest: '60s', lv: 2 },
    { n: 'Reverse curl câble', m: 'Brachioradial / Brachial', eq: 'Câble poulie basse + barre droite', sets: '3×12-15', rest: '60s', lv: 2 },
    { n: 'Curl prise neutre barre EZ', m: 'Brachial / Brachioradial', eq: 'Barre EZ', sets: '3×10-12', rest: '75s', lv: 2 },
    { n: 'Drag curl barre', m: 'Biceps (chef long)', eq: 'Barre', sets: '3×10-12', rest: '60s', lv: 2 },
    { n: 'Curl incliné câble unilatéral', m: 'Biceps (chef long)', eq: 'Câble poulie basse + banc incliné', sets: '3×10-12', rest: '60s', lv: 2 },
    { n: 'Zottman curl', m: 'Biceps / Brachioradial', eq: 'Haltères', sets: '3×10-12', rest: '75s', lv: 2 },
    { n: 'Curl câble à 90° peak', m: 'Biceps (contraction maximale)', eq: 'Câble poulie haute', sets: '3×12-15', rest: '45s', lv: 3 }
  ],
  triceps: [
    { n: 'Dips triceps banc', m: 'Triceps', eq: 'Banc', sets: '4×12-15', rest: '60s', lv: 1 },
    { n: 'Extension barre couché', m: 'Triceps', eq: 'Barre EZ + banc', sets: '4×10-12', rest: '75s', lv: 2 },
    { n: 'Extension haltère tête', m: 'Triceps chef long', eq: 'Haltère', sets: '3×12', rest: '60s', lv: 1 },
    { n: 'Pushdown câble corde', m: 'Triceps', eq: 'Câble + corde', sets: '4×12-15', rest: '60s', lv: 1 },
    { n: 'Pushdown câble barre', m: 'Triceps', eq: 'Câble + barre', sets: '4×12-15', rest: '60s', lv: 1 },
    { n: 'Kick-back haltère', m: 'Triceps chef latéral', eq: 'Haltère', sets: '3×12-15', rest: '45s', lv: 1 },
    { n: 'Close grip bench press', m: 'Triceps / Pectoraux', eq: 'Barre + banc', sets: '4×8-10', rest: '90s', lv: 2 },
    { n: 'Overhead extension câble', m: 'Triceps chef long', eq: 'Câble haute poulie', sets: '3×12-15', rest: '60s', lv: 2 },
    { n: 'Skull crushers EZ', m: 'Triceps', eq: 'Barre EZ + banc', sets: '4×10-12', rest: '90s', lv: 2 },
    { n: 'Extension triceps machine', m: 'Triceps', eq: 'Machine triceps', sets: '3×12-15', rest: '60s', lv: 1 },
    { n: 'JM Press barre', m: 'Triceps', eq: 'Barre + banc', sets: '4×8-10', rest: '90s', lv: 3 },
    { n: 'JM Press EZ', m: 'Triceps (chef long)', eq: 'Barre EZ + banc', sets: '4×8-10', rest: '90s', lv: 3 },
    { n: 'Dips barres parallèles lest', m: 'Triceps / Pectoraux', eq: 'Barres parallèles + ceinture de lest', sets: '4×6-10', rest: '120s', lv: 3 },
    { n: 'Overhead extension haltères bilatéral', m: 'Triceps chef long', eq: 'Haltère', sets: '4×10-12', rest: '75s', lv: 2 },
    { n: 'Kick-back câble', m: 'Triceps chef latéral', eq: 'Câble basse poulie', sets: '3×12-15', rest: '45s', lv: 2 },
    { n: 'Extension triceps élastique debout', m: 'Triceps', eq: 'Élastique', sets: '3×15-20', rest: '45s', lv: 1 },
    { n: 'Diamond push-up', m: 'Triceps / Pectoraux', eq: 'Poids du corps', sets: '4×12-20', rest: '60s', lv: 2 },
    { n: 'Tate press', m: 'Triceps (chefs latéral et médial)', eq: 'Haltères + banc', sets: '4×10-12', rest: '75s', lv: 3 },
    { n: 'Extension triceps bras tendu haltère', m: 'Triceps chef long', eq: 'Haltère', sets: '3×12-15', rest: '60s', lv: 2 },
    { n: 'Bench dips lestés', m: 'Triceps', eq: 'Banc + poids', sets: '3×12-15', rest: '60s', lv: 2 }
  ],
  quadriceps: [
    { n: 'Squat barre', m: 'Quadriceps / Fessiers', eq: 'Barre + rack', sets: '5×5-8', rest: '180s', lv: 2 },
    { n: 'Leg press', m: 'Quadriceps / Fessiers', eq: 'Machine leg press', sets: '4×10-15', rest: '120s', lv: 1 },
    { n: 'Fente avant haltères', m: 'Quadriceps / Fessiers', eq: 'Haltères', sets: '4×10-12', rest: '90s', lv: 1 },
    { n: 'Fente bulgare haltères', m: 'Quadriceps / Fessiers', eq: 'Haltères + banc', sets: '4×10-12', rest: '90s', lv: 2 },
    { n: 'Extension jambes machine', m: 'Quadriceps', eq: 'Machine extension', sets: '4×12-15', rest: '60s', lv: 1 },
    { n: 'Squat gobelet kettlebell', m: 'Quadriceps / Fessiers', eq: 'Kettlebell', sets: '4×12-15', rest: '75s', lv: 1 },
    { n: 'Squat poids de corps', m: 'Quadriceps / Fessiers', eq: 'Poids du corps', sets: '4×15-20', rest: '60s', lv: 1 },
    { n: 'Hack squat machine', m: 'Quadriceps', eq: 'Machine hack squat', sets: '4×10-12', rest: '120s', lv: 2 },
    { n: 'Squat Zercher', m: 'Quadriceps / Fessiers', eq: 'Barre + rack', sets: '4×6-8', rest: '120s', lv: 3 },
    { n: 'Leg press unilatéral', m: 'Quadriceps / Fessiers', eq: 'Machine leg press', sets: '3×10-12', rest: '90s', lv: 2 },
    { n: 'Sissy squat', m: 'Quadriceps', eq: 'Poids du corps', sets: '3×12-15', rest: '60s', lv: 3 },
    { n: 'Fente avant barre', m: 'Quadriceps / Fessiers', eq: 'Barre', sets: '4×8-10', rest: '90s', lv: 2 },
    { n: 'Front squat barre', m: 'Quadriceps', eq: 'Barre + rack', sets: '4×6-8', rest: '120s', lv: 3 },
    { n: 'Fente avant barre marchée', m: 'Quadriceps / Fessiers', eq: 'Barre', sets: '3×10-12 (par jambe)', rest: '90s', lv: 2 },
    { n: 'Step-up genou haut lestés', m: 'Quadriceps / Fessiers', eq: 'Box + haltères', sets: '3×10-12 (par jambe)', rest: '75s', lv: 2 },
    { n: 'Wall sit isométrique', m: 'Quadriceps', eq: 'Poids du corps', sets: '4×30-60s', rest: '60s', lv: 1 },
    { n: 'Terminal leg extension élastique', m: 'Vaste interne (VMO)', eq: 'Élastique', sets: '3×15-20', rest: '45s', lv: 1 },
    { n: 'Leg press 1.5 rep', m: 'Quadriceps', eq: 'Machine leg press', sets: '4×8', rest: '90s', lv: 2 },
    { n: 'Squat sauté', m: 'Quadriceps / Puissance', eq: 'Poids du corps', sets: '4×8-10', rest: '90s', lv: 2 },
    { n: 'Fente latérale haltères', m: 'Quadriceps / Adducteurs', eq: 'Haltères', sets: '4×10-12', rest: '75s', lv: 2 }
  ],
  ischios: [
    { n: 'Deadlift roumain barre', m: 'Ischios / Fessiers / Dorsaux', eq: 'Barre', sets: '4×8-12', rest: '120s', lv: 2 },
    { n: 'Leg curl allongé', m: 'Ischios', eq: 'Machine leg curl', sets: '4×10-12', rest: '75s', lv: 1 },
    { n: 'Leg curl assis', m: 'Ischios', eq: 'Machine leg curl assis', sets: '4×10-12', rest: '75s', lv: 1 },
    { n: 'Sumo deadlift', m: 'Fessiers / Ischios / Adducteurs', eq: 'Barre', sets: '4×5-8', rest: '120s', lv: 2 },
    { n: 'Glute ham raise', m: 'Ischio-jambiers excentrique / Bas du dos', eq: 'Machine GHR', sets: '3×6-10', rest: '90s', lv: 3 },
    { n: 'Nordic curl', m: 'Ischios excentrique', eq: 'Partenaire ou machine', sets: '3×6-8', rest: '120s', lv: 3 },
    { n: 'Leg curl debout câble', m: 'Ischio-jambiers', eq: 'Câble basse poulie', sets: '3×12-15', rest: '60s', lv: 2 },
    { n: 'Romanian deadlift haltères', m: 'Ischio-jambiers / Fessiers', eq: 'Haltères', sets: '4×10-12', rest: '90s', lv: 1 },
    { n: 'Hyperextension ischios-focus', m: 'Ischio-jambiers / Bas du dos', eq: 'Banc à lombaires', sets: '3×12-15', rest: '60s', lv: 1 },
    { n: 'Cable pull-through', m: 'Ischio-jambiers / Fessiers', eq: 'Câble basse poulie', sets: '3×12-15', rest: '60s', lv: 2 },
    { n: 'Leg curl balle suisse', m: 'Ischio-jambiers', eq: 'Swiss ball', sets: '3×10-12', rest: '75s', lv: 2 },
    { n: 'Leg curl debout unilatéral câble', m: 'Ischio-jambiers', eq: 'Câble poulie basse', sets: '3×12-15 (par jambe)', rest: '60s', lv: 2 },
    { n: 'RDL kettlebell', m: 'Ischio-jambiers / Fessiers', eq: 'Kettlebell', sets: '4×10-12', rest: '90s', lv: 2 },
    { n: 'Sliding leg curl', m: 'Ischio-jambiers', eq: 'Disques glissants', sets: '3×8-12', rest: '90s', lv: 2 },
    { n: 'Hip extension 45° ischio-focus', m: 'Ischio-jambiers / Fessiers', eq: 'Banc à 45°', sets: '4×12-15', rest: '60s', lv: 1 },
    { n: 'Snatch-grip RDL barre', m: 'Ischio-jambiers / Lombaires', eq: 'Barre (prise large)', sets: '4×6-8', rest: '120s', lv: 3 },
    { n: 'Leg curl élastique couché', m: 'Ischio-jambiers', eq: 'Élastique', sets: '3×15-20', rest: '45s', lv: 1 },
    { n: 'Jefferson curl', m: 'Ischio-jambiers / Érecteurs (mobilité)', eq: 'Kettlebell ou haltère', sets: '3×5-8', rest: '90s', lv: 3 },
    { n: 'Hamstring walkout', m: 'Ischio-jambiers (isométrique)', eq: 'Poids du corps', sets: '3×8-10', rest: '60s', lv: 2 },
    { n: 'Leg curl assis unilatéral', m: 'Ischio-jambiers', eq: 'Machine leg curl assis', sets: '3×12-15 (par jambe)', rest: '60s', lv: 2 }
  ],
  fessiers: [
    { n: 'Hip thrust barre', m: 'Fessiers', eq: 'Barre + banc', sets: '4×10-15', rest: '90s', lv: 2 },
    { n: 'Hip thrust haltère', m: 'Fessiers', eq: 'Haltère + banc', sets: '4×12-15', rest: '75s', lv: 1 },
    { n: 'Squat sumo', m: 'Fessiers / Adducteurs', eq: 'Barre ou haltère', sets: '4×10-15', rest: '90s', lv: 1 },
    { n: 'Fente reverse haltères', m: 'Fessiers / Quadriceps', eq: 'Haltères', sets: '4×12', rest: '75s', lv: 1 },
    { n: 'Abduction hanche câble', m: 'Fessiers / Abducteurs', eq: 'Câble bas', sets: '4×15-20', rest: '60s', lv: 1 },
    { n: 'Donkey kicks', m: 'Grand fessier', eq: 'Poids du corps', sets: '3×15-20', rest: '45s', lv: 1 },
    { n: 'Glute bridge bilatéral', m: 'Fessiers', eq: 'Poids du corps', sets: '4×15-20', rest: '45s', lv: 1 },
    { n: 'Hip thrust unilatéral', m: 'Fessiers', eq: 'Banc + haltère', sets: '3×10-12', rest: '60s', lv: 2 },
    { n: 'Frog pump', m: 'Grand fessier', eq: 'Poids du corps', sets: '3×15-20', rest: '30s', lv: 1 },
    { n: 'Sumo squat haltère', m: 'Fessiers / Adducteurs', eq: 'Haltères', sets: '4×10-12', rest: '90s', lv: 1 },
    { n: 'Kick-back câble fessiers', m: 'Grand fessier', eq: 'Câble bas', sets: '3×15-20', rest: '45s', lv: 1 },
    { n: 'Abduction debout élastique', m: 'Fessiers / Abducteurs', eq: 'Élastique', sets: '3×15-20', rest: '30s', lv: 1 },
    { n: 'Hip thrust pieds surélevés', m: 'Grand fessier (amplitude étendue)', eq: 'Barre + banc', sets: '4×10-12', rest: '90s', lv: 2 },
    { n: 'Monster walk élastique', m: 'Moyen fessier / Petit fessier', eq: 'Élastique miniband', sets: '3×15-20 (pas)', rest: '45s', lv: 1 },
    { n: 'Clamshell élastique', m: 'Moyen fessier / Piriforme', eq: 'Élastique', sets: '3×15-20 (par côté)', rest: '45s', lv: 1 },
    { n: 'Single-leg glute bridge lestée', m: 'Grand fessier', eq: 'Haltère + sol', sets: '3×12-15 (par jambe)', rest: '60s', lv: 2 },
    { n: 'Abduction latérale machine debout', m: 'Moyen fessier', eq: 'Machine abduction', sets: '3×15-20', rest: '45s', lv: 1 },
    { n: 'Kettlebell swing', m: 'Grand fessier / Chaîne postérieure', eq: 'Kettlebell', sets: '4×15-20', rest: '60s', lv: 2 },
    { n: 'Fente latérale glissée', m: 'Grand fessier / Adducteurs', eq: 'Disques glissants', sets: '3×10-12 (par jambe)', rest: '60s', lv: 2 },
    { n: 'Quadruped hip extension lestée', m: 'Grand fessier', eq: 'Haltère + sol', sets: '3×15 (par jambe)', rest: '45s', lv: 2 }
  ],
  mollets: [
    { n: 'Mollets debout machine', m: 'Mollets', eq: 'Machine mollets', sets: '5×12-20', rest: '60s', lv: 1 },
    { n: 'Mollets debout haltères', m: 'Mollets', eq: 'Haltères', sets: '4×15-20', rest: '60s', lv: 1 },
    { n: 'Mollets assis machine', m: 'Soléaire', eq: 'Machine mollets assis', sets: '4×15-20', rest: '60s', lv: 1 },
    { n: 'Mollets marche sur pointes', m: 'Mollets', eq: 'Poids du corps', sets: '3×20-30', rest: '30s', lv: 1 },
    { n: 'Mollets unilatéraux', m: 'Mollets', eq: 'Poids du corps ou haltère', sets: '4×15', rest: '45s', lv: 2 },
    { n: 'Mollets leg press', m: 'Mollets', eq: 'Machine leg press', sets: '4×15-20', rest: '60s', lv: 1 },
    { n: 'Mollets barre debout', m: 'Mollets', eq: 'Barre', sets: '4×12-15', rest: '60s', lv: 2 },
    { n: 'Donkey calf raise', m: 'Mollets', eq: 'Machine donkey ou lest', sets: '4×15-20', rest: '60s', lv: 2 },
    { n: 'Sauts à la corde', m: 'Mollets', eq: 'Corde à sauter', sets: '4×60s', rest: '60s', lv: 2 },
    { n: 'Mollets isométriques mur', m: 'Gastrocnémien / Soléaire', eq: 'Poids du corps', sets: '4×30-45s', rest: '45s', lv: 1 },
    { n: 'Mollets assis haltère sur genoux', m: 'Soléaire', eq: 'Haltère + banc', sets: '4×15-20', rest: '45s', lv: 1 },
    { n: 'Heel drops excentriques', m: 'Gastrocnémien (excentrique)', eq: 'Poids du corps + step', sets: '3×15-20', rest: '60s', lv: 2 },
    { n: 'Mollets debout sur step barre', m: 'Gastrocnémien', eq: 'Barre + step surélevé', sets: '4×15-20', rest: '45s', lv: 2 },
    { n: 'Saut sur box mollets', m: 'Gastrocnémien / Explosivité', eq: 'Box pliométrique', sets: '4×8-10', rest: '90s', lv: 3 },
    { n: 'Tibial raise mur', m: 'Tibial antérieur', eq: 'Poids du corps', sets: '3×20-30', rest: '30s', lv: 1 },
    { n: 'Triple extension mollets sauts', m: 'Gastrocnémien / Explosivité', eq: 'Poids du corps', sets: '4×8-12', rest: '75s', lv: 3 },
    { n: 'Mollets assis élastique', m: 'Soléaire', eq: 'Élastique', sets: '3×20-25', rest: '30s', lv: 1 },
    { n: 'Farmer carry sur orteils', m: 'Gastrocnémien / Équilibre dynamique', eq: 'Haltères', sets: '3×20-30m', rest: '60s', lv: 2 }
  ],
  trapezes: [
    { n: 'Shrug barre', m: 'Trap\u00e8zes sup\u00e9rieurs', eq: 'Barre', sets: '5×8-12', rest: '90s', lv: 1 },
    { n: 'Shrug halt\u00e8res', m: 'Trap\u00e8zes sup\u00e9rieurs', eq: 'Halt\u00e8res', sets: '4×10-15', rest: '60s', lv: 1 },
    { n: 'Shrug machine', m: 'Trap\u00e8zes sup\u00e9rieurs', eq: 'Machine', sets: '4×12-15', rest: '60s', lv: 1 },
    { n: 'Face pull c\u00e2ble', m: 'Trap\u00e8zes moyens + rotateurs', eq: 'C\u00e2ble + corde', sets: '4×15', rest: '60s', lv: 1 },
    { n: 'Tirage menton barre', m: 'Trap\u00e8zes + \u00e9paules', eq: 'Barre', sets: '4×10-12', rest: '60s', lv: 2 },
    { n: 'Rowing debout haltères', m: 'Trapèzes supérieurs + épaules', eq: 'Haltères', sets: '4×10-12', rest: '60s', lv: 1 },
    { n: 'Rowing buste pench\u00e9 prise large', m: 'Trap\u00e8zes moyens + rhobo\u00efdes', eq: 'Barre', sets: '4×10', rest: '90s', lv: 2 },
    { n: 'Shrug halt\u00e8re unilat\u00e9ral', m: 'Trap\u00e8zes', eq: 'Halt\u00e8re', sets: '4×12', rest: '60s', lv: 1 },
    { n: 'Tirage menton c\u00e2ble', m: 'Trap\u00e8zes + \u00e9paules', eq: 'C\u00e2ble', sets: '4×12', rest: '60s', lv: 2 },
    { n: 'Shrug barre EZ', m: 'Trapèzes supérieurs', eq: 'Barre EZ', sets: '4×12-15', rest: '60s', lv: 1 },
    { n: 'Shrug câble unilatéral', m: 'Trapèzes supérieurs', eq: 'Câble poulie basse + poignée', sets: '4×12-15', rest: '60s', lv: 2 },
    { n: 'Power shrug barre', m: 'Trapèzes supérieurs / Explosif', eq: 'Barre', sets: '4×6-8', rest: '120s', lv: 3 },
    { n: 'Rowing prise large debout câble', m: 'Trapèzes moyens / Rhomboïdes', eq: 'Câble poulie basse + barre longue', sets: '4×12-15', rest: '75s', lv: 2 },
    { n: 'Élévation en Y banc incliné', m: 'Trapèzes inférieurs / Moyens', eq: 'Haltères légers + banc incliné', sets: '3×12-15', rest: '60s', lv: 2 },
    { n: 'Dépression scapulaire à la barre', m: 'Trapèzes inférieurs / Dentelé antérieur', eq: 'Barre de traction', sets: '3×10-15', rest: '60s', lv: 2 },
    { n: 'Face pull élastique', m: 'Trapèzes moyens / Rotateurs', eq: 'Élastique', sets: '4×15-20', rest: '45s', lv: 1 },
    { n: 'Shrug isométrique barre', m: 'Trapèzes supérieurs', eq: 'Barre', sets: '4×8-10 (maintien 3s)', rest: '90s', lv: 2 },
    { n: 'Farmer carry', m: 'Trapèzes supérieurs / Core / Avant-bras', eq: 'Haltères lourds', sets: '4×20-30m', rest: '90s', lv: 2 },
    { n: 'Rowing buste penché câble prise neutre', m: 'Trapèzes moyens / Rhomboïdes', eq: 'Câble poulie haute + corde', sets: '4×12-15', rest: '75s', lv: 2 }
  ],
  lombaires: [
    { n: 'Soulev\u00e9 de terre conventionnel', m: 'Lombaires + dos complet', eq: 'Barre', sets: '4×5', rest: '240s', lv: 3 },
    { n: 'Good morning barre', m: 'Lombaires + ischios', eq: 'Barre', sets: '4×8-10', rest: '120s', lv: 2 },
    { n: 'Hyperextension banc lombaires', m: 'Lombaires + fessiers', eq: 'Banc \u00e0 lombaires', sets: '4×12-15', rest: '90s', lv: 1 },
    { n: 'Soulev\u00e9 de terre roumain', m: 'Lombaires + ischios + fessiers', eq: 'Barre', sets: '4×8-10', rest: '120s', lv: 2 },
    { n: 'Planche ventrale (prone plank)', m: 'Lombaires + core', eq: 'Sol', sets: '4×45s', rest: '60s', lv: 1 },
    { n: 'Superman', m: 'Lombaires + \u00e9recteurs', eq: 'Sol', sets: '4×15', rest: '45s', lv: 1 },
    { n: 'Bird dog', m: 'Lombaires + core stabilisation', eq: 'Sol', sets: '3×12', rest: '45s', lv: 1 },
    { n: 'Hyperextension reverse', m: 'Lombaires + fessiers', eq: 'Banc plat', sets: '3×15', rest: '60s', lv: 1 },
    { n: 'Good morning halt\u00e8res', m: 'Lombaires + ischios', eq: 'Halt\u00e8res', sets: '4×12', rest: '90s', lv: 2 },
    { n: 'Kettlebell swing américain', m: 'Érecteurs du rachis / Fessiers', eq: 'Kettlebell', sets: '4×15-20', rest: '60s', lv: 2 },
    { n: 'Suitcase carry', m: 'Carré des lombes / Stabilisateurs latéraux', eq: 'Haltère ou kettlebell', sets: '3×20-30m (par côté)', rest: '60s', lv: 2 },
    { n: 'Pallof press à genoux', m: 'Multifides / Core anti-rotation', eq: 'Câble ou élastique', sets: '3×10-12 (par côté)', rest: '45s', lv: 2 },
    { n: 'McGill curl-up', m: 'Multifides / Érecteurs (stabilisation)', eq: 'Poids du corps', sets: '3×8-10', rest: '45s', lv: 1 },
    { n: 'Back extension GHD lestée', m: 'Érecteurs du rachis', eq: 'Machine GHD + disque', sets: '4×10-15', rest: '75s', lv: 3 },
    { n: 'Stiff-leg deadlift haltères', m: 'Érecteurs / Ischio-jambiers', eq: 'Haltères', sets: '4×10-12', rest: '90s', lv: 2 },
    { n: 'Rotation du tronc câble', m: 'Carré des lombes / Obliques', eq: 'Câble poulie moyenne', sets: '3×12-15 (par côté)', rest: '45s', lv: 2 },
    { n: 'Deadbug anti-flexion bâton', m: 'Multifides / Érecteurs', eq: 'Poids du corps', sets: '3×8 (par côté)', rest: '45s', lv: 1 },
    { n: 'Soulevé de terre hex bar', m: 'Érecteurs du rachis / Quadriceps / Fessiers', eq: 'Trap bar (hex bar)', sets: '4×5-6', rest: '180s', lv: 2 },
    { n: 'Good morning assis barre', m: 'Lombaires + ischios', eq: 'Barre + banc', sets: '4×10-12', rest: '90s', lv: 3 }
  ],
  abdos: [
    { n: 'Crunch classique', m: 'Abdominaux', eq: 'Poids du corps', sets: '4×20', rest: '45s', lv: 1 },
    { n: 'Relevé de jambes suspendu', m: 'Abdominaux bas', eq: 'Barre de traction', sets: '4×10-15', rest: '60s', lv: 2 },
    { n: 'Planche abdominale', m: 'Abdominaux / Core', eq: 'Poids du corps', sets: '4×30-60s', rest: '45s', lv: 1 },
    { n: 'Russian twist', m: 'Obliques', eq: 'Poids du corps ou disque', sets: '3×20', rest: '45s', lv: 1 },
    { n: 'Roulette abdominale', m: 'Abdominaux / Core', eq: 'Roulette', sets: '4×10-15', rest: '60s', lv: 3 },
    { n: 'Mountain climbers', m: 'Abdominaux / Core', eq: 'Poids du corps', sets: '4×30s', rest: '30s', lv: 1 },
    { n: 'Crunch câble poulie haute', m: 'Abdominaux', eq: 'Câble + corde', sets: '4×15-20', rest: '45s', lv: 2 },
    { n: 'Dead bug', m: 'Abdominaux / Core', eq: 'Poids du corps', sets: '3×10-12', rest: '60s', lv: 1 },
    { n: 'L-sit', m: 'Abdominaux / Core', eq: 'Barres parallèles', sets: '3×20-30s', rest: '60s', lv: 3 },
    { n: 'Hollow body hold', m: 'Abdominaux / Core', eq: 'Poids du corps', sets: '3×30-45s', rest: '60s', lv: 2 },
    { n: 'Ab rollout sur genoux', m: 'Abdominaux / Core', eq: 'Roulette abdominale', sets: '3×10-12', rest: '60s', lv: 2 },
    { n: 'Crunch décliné lestée', m: 'Rectus abdominis (portion haute)', eq: 'Banc décliné + disque', sets: '3×12-15', rest: '60s', lv: 2 },
    { n: 'Knee tucks suspendu', m: 'Abdominaux bas', eq: 'Barres parallèles ou barre de traction', sets: '3×12-15', rest: '60s', lv: 2 },
    { n: 'Oblique crunch au sol', m: 'Obliques', eq: 'Poids du corps', sets: '3×15-20 (par côté)', rest: '30s', lv: 1 },
    { n: 'Cable reverse crunch', m: 'Abdominaux bas', eq: 'Câble poulie basse + corde', sets: '3×12-15', rest: '60s', lv: 2 },
    { n: 'Swiss ball crunch', m: 'Abdominaux', eq: 'Swiss ball', sets: '3×15-20', rest: '45s', lv: 1 },
    { n: 'V-up complet', m: 'Abdominaux', eq: 'Poids du corps', sets: '3×10-15', rest: '60s', lv: 2 },
    { n: 'Planche abdominale dynamique', m: 'Abdominaux / Core', eq: 'Poids du corps', sets: '3×45-60s', rest: '45s', lv: 2 },
    { n: 'Ab crunch machine', m: 'Abdominaux', eq: 'Machine ab crunch', sets: '3×15-20', rest: '45s', lv: 1 },
    { n: 'Hollow rock', m: 'Abdominaux / Core', eq: 'Poids du corps', sets: '3×20-30s', rest: '45s', lv: 2 }
  ]
};
...
function getAlternativeExercises(muscle, excludeName, maxCount, userLevel) {
  ...
  // Filter by user level: beginner/intermediate see lv≤2, advanced/pro see all lv≤3
  var maxLv = (userLevel === 'advanced' || userLevel === 'pro') ? 3 : 2;
  var lvFiltered = pool.filter(function(ex) { return !ex.lv || ex.lv <= maxLv; });
