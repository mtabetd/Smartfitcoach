...
,
    ...
    { n: "Développé décliné haltères", m: "Pectoraux inférieurs", eq: "Haltères + banc décliné", sets: "4×8-12", rest: "90s", video: "https://www.youtube.com/results?search_query=decline+dumbbell+press&sp=EgIYAQ%253D%253D", warn: "CONTRE-INDIQUÉ grossesse T2/T3.", desc: "Banc décliné -15 à -30°. Ciblage pectoraux bas avec contrôle unilatéral des haltères.", tips: ["Pieds bien calés", "Descente jusqu'au bas du pec", "Pas de rebond"], lv: 2, tags: ["pectoraux", "pectoraux-inferieurs", "halteres"] },
    { n: "Svend press", m: "Pectoraux / Gainage", eq: "Disque (5-10 kg)", sets: "3×12-15", rest: "60s", video: "https://www.youtube.com/results?search_query=svend+press+plate&sp=EgIYAQ%253D%253D", desc: "Pressing horizontal d'un disque tenu entre les paumes. Activation constante par isométrie d'adduction.", tips: ["Paumes pressent fort le disque", "Poussée linéaire devant le sternum", "Tension continue 15 reps"], lv: 1, tags: ["pectoraux", "adduction", "finisher"] },
    { n: "Pompes déficit", m: "Pectoraux / Triceps", eq: "Poids du corps + 2 surfaces élevées", sets: "3×10-15", rest: "60s", video: "https://www.youtube.com/results?search_query=deficit+push+ups&sp=EgIYAQ%253D%253D", desc: "Pompes avec mains surélevées (parallettes/disques) pour augmenter l'amplitude d'étirement du pectoral.", tips: ["Descente poitrine en dessous des mains", "Coudes 45°", "Maîtrise excentrique 2-3s"], lv: 2, tags: ["pectoraux", "poids du corps", "home"] },
    { n: "Développé machine convergent", m: "Pectoraux", eq: "Machine convergente", sets: "4×10-12", rest: "75s", video: "https://www.youtube.com/results?search_query=converging+chest+press+machine&sp=EgIYAQ%253D%253D", desc: "Machine dont les bras convergent en fin de poussée — mime un mouvement d'adduction + pressing.", tips: ["Ajuster assise pour que les poignées soient à mi-poitrine", "Serrer les pecs en haut 1s", "Ne pas verrouiller coudes"], lv: 1, tags: ["pectoraux", "machine", "beginner-friendly"] },
    { n: "Cable crossover haut vers bas", m: "Pectoraux inférieurs", eq: "Poulie haute", sets: "3×12-15", rest: "60s", video: "https://www.youtube.com/results?search_query=high+to+low+cable+crossover&sp=EgIYAQ%253D%253D", desc: "Poulies hautes, trajectoire diagonale vers le bas devant le bassin. Cible les fibres basses du pectoral.", tips: ["Fente légère pour stabilité", "Coudes stables légèrement fléchis", "Croiser les mains en bas"], lv: 2, tags: ["pectoraux", "cable", "pectoraux-inferieurs", "isolation"] }
  ],
...
,
    ...
    { n: "Rowing machine assise", m: "Dos / Rhomboïdes", eq: "Machine tirage horizontal", sets: "4×10-12", rest: "75s", video: "https://www.youtube.com/results?search_query=seated+machine+row&sp=EgIYAQ%253D%253D", desc: "Machine de tirage horizontal assise. Tirer les poignées vers l'abdomen en rapprochant les omoplates.", tips: ["Buste droit sans balancement", "Coudes proches du corps", "Pause contractée 1s", "Ne pas laisser les épaules remonter"], lv: 1, tags: ["dos", "machine", "beginner-friendly"] },
    { n: "Tirage bras tendus corde", m: "Grand dorsal / Triceps long", eq: "Poulie haute + corde", sets: "3×12-15", rest: "60s", video: "https://www.youtube.com/results?search_query=straight+arm+pulldown+rope&sp=EgIYAQ%253D%253D", desc: "Poulie haute, bras tendus, pousser la corde vers les cuisses en gardant les coudes verrouillés.", tips: ["Bras quasi tendus — légère flexion 10°", "Engage purement le grand dorsal (isolation)", "Buste légèrement incliné vers l'avant"], lv: 2, tags: ["dos", "cable", "isolation", "grand-dorsal"] },
    { n: "Meadows row", m: "Dos / Épaules postérieures", eq: "Barre landmine", sets: "4×8-10 par côté", rest: "90s", video: "https://www.youtube.com/results?search_query=meadows+row+landmine&sp=EgIYAQ%253D%253D", desc: "Rowing unilatéral landmine popularisé par John Meadows. Prise pronation, travail postérieur + rhomboïdes.", tips: ["Pied avant côté opposé au bras de travail", "Tirer vers la hanche côté travail", "ROM large, squeeze 1s"], lv: 3, tags: ["dos", "landmine", "unilateral"] },
  ...
  shoulders: [
    ...
    },
    {
        ...
        sets: "4×12-15",
        rest: "60s",
        video: "https://www.youtube.com/results?search_query=cable+lateral+raise+shoulder+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "4×10-12",
        rest: "75s",
        video: "https://www.youtube.com/results?search_query=machine+shoulder+press+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "3×12-15",
        rest: "45s",
        video: "https://www.youtube.com/results?search_query=dumbbell+y+raise+prone+shoulder+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "3×12-15",
        rest: "45s",
        video: "https://www.youtube.com/results?search_query=prone+trap+raise+lower+trapezius+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "4×12-15",
        rest: "60s",
        video: "https://www.youtube.com/results?search_query=leaning+lateral+raise+side+delt+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "4×8-10",
        rest: "90s",
        video: "https://www.youtube.com/results?search_query=kettlebell+press+shoulder+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "3×10-12",
        rest: "60s",
        video: "https://www.youtube.com/results?search_query=cuban+press+rotator+cuff+shoulder+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        rest: "60s",
        video: "https://www.youtube.com/results?search_query=overhead+carry+waiter+walk+shoulder+stability+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
  ...
  biceps: [
    ...
    },
    {
        ...
        sets: "3×10-15",
        rest: "60s",
        video: "https://www.youtube.com/results?search_query=bayesian+cable+curl+long+head+bicep+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "3×12-15",
        rest: "60s",
        video: "https://www.youtube.com/results?search_query=reverse+curl+brachioradialis+forearm+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "3×10-12",
        rest: "75s",
        video: "https://www.youtube.com/results?search_query=zottman+curl+bicep+forearm+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "3×10-12",
        rest: "60s",
        video: "https://www.youtube.com/results?search_query=drag+curl+bicep+long+head+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "3×10-12",
        rest: "60s",
        video: "https://www.youtube.com/results?search_query=cross+body+hammer+curl+brachialis+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    { n: "Curl haltères incliné", m: "Biceps long", eq: "Haltères + banc incliné", sets: "4×10-12", rest: "75s", video: "https://www.youtube.com/results?search_query=incline+dumbbell+curl&sp=EgIYAQ%253D%253D", desc: "Banc incliné 45°, bras pendants derrière le corps. Étirement maximal du chef long du biceps.", tips: ["Laisse bras bien pendants", "Coudes fixes ne dérivent pas devant", "Supination complète en haut"], lv: 1, tags: ["bras", "biceps-long", "halteres", "stretch"] },
    { n: "Preacher curl", m: "Biceps court", eq: "Banc preacher + barre EZ", sets: "3×8-12", rest: "75s", video: "https://www.youtube.com/results?search_query=preacher+curl+bench&sp=EgIYAQ%253D%253D", desc: "Curl barre EZ sur banc preacher — bras bloqués sur le coussinet, cible pic biceps.", tips: ["Descente contrôlée 3s", "Ne pas verrouiller coude en bas", "Coudes stables sur banc"], lv: 1, tags: ["bras", "biceps-court", "banc-preacher"] },
    { n: "Spider curl", m: "Biceps", eq: "Banc incliné (face contre dossier) + haltères", sets: "3×10-12", rest: "60s", video: "https://www.youtube.com/results?search_query=spider+curl+dumbbell&sp=EgIYAQ%253D%253D", desc: "Torse contre banc incliné face au dossier, bras pendants verticalement — isole parfaitement le biceps.", tips: ["Bras complètement pendants", "Concentration pic du biceps", "Supination forte"], lv: 2, tags: ["bras", "biceps", "halteres", "isolation"] }
  ],
  ...
  triceps: [
    ...
    },
    {
        ...
        sets: "3×12-15",
        rest: "60s",
        video: "https://www.youtube.com/results?search_query=overhead+cable+tricep+extension+long+head+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "3×12-15",
        rest: "45s",
        video: "https://www.youtube.com/results?search_query=single+arm+cable+pushdown+tricep+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "3×12-15",
        rest: "45s",
        video: "https://www.youtube.com/results?search_query=cable+tricep+kickback+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "4×10-12",
        rest: "75s",
        video: "https://www.youtube.com/results?search_query=tate+press+tricep+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "4×6-10",
        rest: "120s",
        video: "https://www.youtube.com/results?search_query=weighted+dips+chest+tricep+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "4×4-6",
        rest: "180s",
        video: "https://www.youtube.com/results?search_query=board+press+powerlifting+tricep+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    { n: "Extension triceps haltère unilatéral overhead", m: "Triceps long", eq: "1 haltère", sets: "3×10-12 par côté", rest: "60s", video: "https://www.youtube.com/results?search_query=overhead+triceps+extension+single+arm&sp=EgIYAQ%253D%253D", desc: "Haltère au-dessus de la tête tenu à une main, flexion-extension. Stretch profond du triceps long.", tips: ["Coude près de l'oreille", "Bras fixe", "Étirement max en bas"], lv: 1, tags: ["bras", "triceps-long", "halteres", "stretch"] }
  ],
...
,
    ...
    },
    {
        ...
        sets: "4×10-15",
        rest: "90s",
        video: "https://www.youtube.com/results?search_query=belt+squat+machine+quadriceps+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "3×12-15",
        rest: "60s",
        video: "https://www.youtube.com/results?search_query=peterson+step+up+vmo+quadriceps+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "4×10-15",
        rest: "90s",
        video: "https://www.youtube.com/results?search_query=spanish+squat+patellar+tendon+rehabilitation+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "4×10-15",
        rest: "90s",
        video: "https://www.youtube.com/results?search_query=leg+press+low+foot+placement+quadriceps+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "4×15-20",
        rest: "45s",
        video: "https://www.youtube.com/results?search_query=seated+calf+raise+soleus+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "4×15-20",
        rest: "45s",
        video: "https://www.youtube.com/results?search_query=leg+press+calf+raise+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        rest: "45s",
        video: "https://www.youtube.com/results?search_query=single+leg+calf+raise+weighted+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "4×15-20",
        rest: "45s",
        video: "https://www.youtube.com/results?search_query=donkey+calf+raise+gastrocnemius+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "4×15-20",
        rest: "45s",
        video: "https://www.youtube.com/results?search_query=smith+machine+calf+raise+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    { n: "Fentes marchées", m: "Quadriceps / Fessiers", eq: "2 haltères", sets: "3×12 pas", rest: "90s", video: "https://www.youtube.com/results?search_query=walking+lunges+dumbbells&sp=EgIYAQ%253D%253D", desc: "Fentes alternées en marchant — chaque pas = une fente. Stimulus unilatéral dynamique.", tips: ["Grand pas, genou ne dépasse pas orteil", "Descente 90°", "Buste vertical"], lv: 2, tags: ["jambes", "halteres", "unilateral", "fonctionnel"] },
    { n: "Squat talons surélevés (heel-elevated)", m: "Quadriceps", eq: "Haltère + cales/plaques", sets: "4×10-12", rest: "75s", video: "https://www.youtube.com/results?search_query=heel+elevated+goblet+squat&sp=EgIYAQ%253D%253D", desc: "Goblet squat avec talons sur planches de 2-5 cm. Permet squat profond quad-focus pour mobilité cheville limitée.", tips: ["Talons bien à plat sur la cale", "Descente sous parallèle", "Buste vertical", "Idéal pour mobilité cheville limitée"], lv: 1, tags: ["jambes", "quadriceps", "home", "mobilite-cheville"] },
    { n: "Leg extension unilatéral", m: "Quadriceps (Vaste interne)", eq: "Machine leg extension", sets: "3×12-15 par jambe", rest: "60s", video: "https://www.youtube.com/results?search_query=single+leg+extension&sp=EgIYAQ%253D%253D", desc: "Extension du genou une jambe à la fois. Isole chaque quadriceps et corrige asymétries.", tips: ["Pause 1s en haut", "Descente 3s", "Focus pic du vaste interne"], lv: 1, tags: ["jambes", "quadriceps", "machine", "unilateral"] },
...
,
    ...
    },
    {
        ...
        sets: "3×4-8",
        rest: "120s",
        video: "https://www.youtube.com/results?search_query=nordic+hamstring+curl+eccentric+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "4×8-12",
        rest: "90s",
        video: "https://www.youtube.com/results?search_query=glute+ham+raise+GHR+posterior+chain+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "4×10-12",
        rest: "90s",
        video: "https://www.youtube.com/results?search_query=b+stance+rdl+single+leg+deadlift+progression+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        rest: "60s",
        video: "https://www.youtube.com/results?search_query=lying+single+leg+curl+hamstring+unilateral+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "3×12-15",
        rest: "60s",
        video: "https://www.youtube.com/results?search_query=seated+leg+curl+hamstring+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "4×12-15",
        rest: "60s",
        video: "https://www.youtube.com/results?search_query=45+degree+hip+extension+back+extension+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "3×12-15",
        rest: "60s",
        video: "https://www.youtube.com/results?search_query=hyperextension+back+extension+glute+ham+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "4×5-8",
        rest: "120s",
        video: "https://www.youtube.com/results?search_query=trap+bar+deadlift+hex+bar+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "4×12-15",
        rest: "90s",
        video: "https://www.youtube.com/results?search_query=banded+hip+thrust+glute+activation+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
  ...
  abs: [
    ...
    },
    {
        ...
        sets: "3×8-10",
        rest: "45s",
        video: "https://www.youtube.com/results?search_query=dead+bug+core+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "3×8-10",
        rest: "45s",
        video: "https://www.youtube.com/results?search_query=bird+dog+core+stability+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "3×8-12",
        rest: "75s",
        video: "https://www.youtube.com/results?search_query=toes+to+bar+hanging+core+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        rest: "60s",
        video: "https://www.youtube.com/results?search_query=copenhagen+plank+adductor+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        rest: "45s",
        video: "https://www.youtube.com/results?search_query=side+plank+rotation+thread+needle+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "3×10-12 par côté",
        rest: "60s",
        video: "https://www.youtube.com/results?search_query=landmine+rotation+core+oblique+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        rest: "45s",
        video: "https://www.youtube.com/results?search_query=stir+the+pot+swiss+ball+core+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "3×12-15",
        rest: "60s",
        video: "https://www.youtube.com/results?search_query=weighted+sit+up+ab+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "3×8-12",
        rest: "60s",
        video: "https://www.youtube.com/results?search_query=ab+wheel+rollout+core+anti+extension+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
    ...
    },
    {
        ...
        sets: "3×10-15",
        rest: "75s",
        video: "https://www.youtube.com/results?search_query=hanging+knee+raise+weighted+core+exercise+animation+tutorial&sp=EgIYAQ%253D%253D",
  ...
  cardio: [
    ...
    { n: "Rameur (rowing machine)", m: "Chaîne postérieure / Cardio", eq: "Rameur Concept2", sets: "20-40 min ou 5×500m", rest: "N/A ou 90s entre intervalles", video: "https://www.youtube.com/results?search_query=concept2+rowing+technique&sp=EgIYAQ%253D%253D", desc: "Rameur Concept2 : pousser des jambes → bascule buste → tirage bras. Cardio full-body low-impact.", tips: ["Ordre: jambes → buste → bras (tirer)", "Retour: bras → buste → jambes", "Cadence 24-30 coups/min pour endurance"], lv: 1, tags: ["cardio", "full-body", "low-impact", "concept2"] },
    { n: "Assault bike", m: "Cardio / Full-body", eq: "Assault bike", sets: "10-30 min ou intervalles 30s/30s", rest: "N/A ou 30s", video: "https://www.youtube.com/results?search_query=assault+bike+technique&sp=EgIYAQ%253D%253D", desc: "Vélo cardio avec bras + jambes couplés. Zone brutale (anaérobie) en sprints courts.", tips: ["Pousser/tirer les manches activement", "Sprints courts 30s max effort", "Récup low-intensity entre sprints"], lv: 2, tags: ["cardio", "hiit", "full-body", "crossfit"] },
    { n: "Ski erg", m: "Dos / Triceps / Cardio", eq: "Ski erg Concept2", sets: "15-30 min ou 4×500m", rest: "N/A ou 90s", video: "https://www.youtube.com/results?search_query=ski+erg+technique&sp=EgIYAQ%253D%253D", desc: "Simulateur de ski de fond — tirage vertical alterné haut-bas. Conditionnement dos + triceps + cardio.", tips: ["Bascule buste vers avant en tirant", "Engage les lats + triceps", "Rythme régulier respiration"], lv: 2, tags: ["cardio", "dos", "crossfit"] },
    { n: "Corde à sauter (double unders)", m: "Mollets / Cardio / Coordination", eq: "Corde de speed", sets: "10×1 min ou 100 DU", rest: "30-60s", video: "https://www.youtube.com/results?search_query=double+unders+technique&sp=EgIYAQ%253D%253D", desc: "Saut simple puis double : la corde passe 2 fois sous les pieds par saut. Cardio + coordination.", tips: ["Rotation du poignet rapide, pas des bras", "Petits sauts ~3cm hauteur", "Commence single unders 100", "Progression vers doubles"], lv: 2, tags: ["cardio", "crossfit", "coordination", "mollets"] }
  ],
  ...
  prehab: [
    ...
    { n: "Scapular push-ups", m: "Sérratus antérieur / Scapula", eq: "Poids du corps", sets: "3×10-15", rest: "30s", video: "https://www.youtube.com/results?search_query=scapular+push+ups&sp=EgIYAQ%253D%253D", desc: "Position de pompe classique, bras tendus. Protraction/rétraction des omoplates sans fléchir les coudes.", tips: ["Coudes restent tendus", "Écarter omoplates puis rapprocher", "Santé scapulaire + stabilité épaule"], lv: 1, tags: ["prehab", "scapula", "serratus", "home"] },
    { n: "Band pull-apart", m: "Trapèzes moyens / Rhomboïdes / Deltoïde postérieur", eq: "Élastique", sets: "3×15-20", rest: "30s", video: "https://www.youtube.com/results?search_query=band+pull+apart&sp=EgIYAQ%253D%253D", desc: "Élastique tendu à hauteur poitrine, bras tendus, écarter les mains jusqu'à toucher les côtés. Santé posturale.", tips: ["Bras restent à l'horizontale", "Squeeze omoplates 1s", "Idéal après session bench"], lv: 1, tags: ["prehab", "posture", "elastique", "home"] },
    { n: "YTW raises", m: "Trapèzes inférieurs / Arrière-épaule", eq: "Haltères légers (1-3 kg) + banc incliné", sets: "3×10 pour chaque lettre", rest: "45s", video: "https://www.youtube.com/results?search_query=ytw+raises+prone+scapular&sp=EgIYAQ%253D%253D", desc: "Sur banc incliné face au sol, enchaîne les positions Y (bras en Y), T (bras écartés), W (épaules basses, coudes bas). Active trapèzes inférieurs + coiffe.", tips: ["Haltères très légers", "Pouces vers le plafond", "Focus contraction scapulaire"], lv: 1, tags: ["prehab", "scapula", "trapezes-inferieurs", "home"] }
  ]
};
